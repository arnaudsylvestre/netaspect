            ...
            return new Dictionary<ErrorCode, ErrorInfo>
               {
                  ...
                  {ErrorCode.UnknownParameter, new ErrorInfo("The parameter '{0}' in the interceptor {1} of the aspect {2} is unknown. Expected one of : {3}")},
                  ...
                  {ErrorCode.ParameterAlreadyDeclared, new ErrorInfo("The parameter {0} in the interceptor {1} of the aspect {2} is already declared")},
                  ...
                  {ErrorCode.AssemblyGeneratedIsNotCompliant, new ErrorInfo(ErrorLevel.Failure, "An internal error occured : {0}")},
