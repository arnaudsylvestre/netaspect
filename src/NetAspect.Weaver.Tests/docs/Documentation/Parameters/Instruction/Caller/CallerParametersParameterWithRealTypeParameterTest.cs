...
{
   public class CallerParametersParameterWithRealTypeParameterTest :
      NetAspectTest<CallerParametersParameterWithRealTypeParameterTest.ClassToWeave>
   {
       public CallerParametersParameterWithRealTypeParameterTest()
