       ...
       protected override Action<List<ErrorReport.Error>> CreateErrorHandlerProvider()
       {
           return errorHandler => errorHandler.Add(
              new ErrorReport.Error
              {
                  ...
                  Message = string.Format("The parameter 'unknown' in the interceptor BeforeMethodForParameter of the aspect {0} is unknown. Expected one of : parametervalue, parameter, constructor, parameters, v, instance", typeof(LogAttribute).FullName)
              });
       }
