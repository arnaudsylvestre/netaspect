...
namespace NetAspect.Weaver.Tests.unit.InstructionWeaving.Parameters.Called
{
      ...
      NetAspectTest<AfterCallMethodCalledParameterWithBadTypeTest.ClassToWeave>
   {
            ...
            errorHandler =>
               errorHandler.Add(
                  new ErrorReport.Error
                  {
                     ...
                     Message =
                        string.Format(
                           "the instance parameter in the method AfterCallMethod of the type '{0}' is declared with the type 'System.Int32' but it is expected to be {1}",
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterCallMethod(int instance)
         {
         }
      }
   }
