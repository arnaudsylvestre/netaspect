...
namespace NetAspect.Weaver.Tests.unit.InstructionWeaving.Parameters.CalledParameters
{
      ...
      NetAspectTest<AfterCallMethodCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
            ...
            errorHandler =>
               errorHandler.Add(
                  new ErrorReport.Error
                  {
                     ...
                     Message =
                        string.Format(
                           "the parameters parameter in the method AfterCallMethod of the type '{0}' is declared with the type 'System.Int32' but it is expected to be System.Object[]",
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterCallMethod(int parameters)
         {
         }
      }
   }
