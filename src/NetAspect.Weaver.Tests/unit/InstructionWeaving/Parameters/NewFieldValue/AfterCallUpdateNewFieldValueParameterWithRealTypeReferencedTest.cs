...
{
   public class AfterCallUpdateNewFieldValueParameterWithRealTypeReferencedTest :
      NetAspectTest<AfterCallUpdateNewFieldValueParameterWithRealTypeReferencedTest.ClassToWeave>
   {
