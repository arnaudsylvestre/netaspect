              ...
              errorHandler =>
                 errorHandler.Add(
                    new ErrorReport.Error
                    {
                        ...
                        Message =
                           string.Format(
                              "The parameter 'result' in the interceptor BeforeCallMethod of the aspect {0} is unknown. Expected one of : instance, parameters, method, callerinstance, callerparameters, callermethod, columnnumber, linenumber, filepath, filename", typeof(MyAspect).FullName)
                    });
       }
