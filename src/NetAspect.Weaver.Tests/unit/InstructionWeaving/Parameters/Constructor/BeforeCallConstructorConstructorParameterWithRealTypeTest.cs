...
{
   public class BeforeCallConstructorConstructorParameterWithRealTypeTest :
      NetAspectTest<BeforeCallConstructorConstructorParameterWithRealTypeTest.ClassToWeave>
   {
