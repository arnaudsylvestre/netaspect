...
{
   public class AfterCallMethodParametersTest :
      NetAspectTest<AfterCallMethodParametersTest.MyInt>
   {
      public AfterCallMethodParametersTest()
      ...
      public class LogAttribute : Attribute
      {
         ...
         public void AfterCallMethod(string callerFormat,
            MyIntUser caller,
            MyInt called,
            int columnNumber,
            int lineNumber,
            ...
            MethodBase callerMethod)
         {
            ...
            Assert.AreEqual("AfterCallMethodParametersTest.cs", fileName);
