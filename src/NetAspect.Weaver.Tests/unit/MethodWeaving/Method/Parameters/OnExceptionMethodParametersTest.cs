...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Method.Parameters
{
   public class OnExceptionMethodParametersTest : NetAspectTest<OnExceptionMethodParametersTest.MyInt>
   {
      ...
      public class LogAttribute : Attribute
      {
         ...
         public void OnExceptionMethod(object instance, MethodInfo method, object[] parameters, int v, Exception exception, string fileName, string filePath, int lineNumber, int columnNumber)
         {
            Called = true;
