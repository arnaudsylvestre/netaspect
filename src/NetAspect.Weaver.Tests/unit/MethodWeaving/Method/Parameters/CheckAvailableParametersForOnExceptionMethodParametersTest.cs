       ...
       protected override Action<List<ErrorReport.Error>> CreateErrorHandlerProvider()
       {
           return errorHandler => errorHandler.Add(
              new ErrorReport.Error
              {
                  ...
                  Message = string.Format("The parameter 'unknown' in the interceptor OnExceptionMethod of the aspect {0} is unknown. Expected one of : instance, method, parameters, v, linenumber, columnnumber, filename, filepath, exception", typeof(LogAttribute).FullName)
              });
       }
