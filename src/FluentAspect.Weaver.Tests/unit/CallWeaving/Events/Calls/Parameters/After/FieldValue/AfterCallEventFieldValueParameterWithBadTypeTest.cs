...
{
    public class AfterCallEventFieldValueParameterWithBadTypeTest : NetAspectTest<AfterCallEventFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(int fieldValue)
         {
