...
{
    public class AfterCallGetFieldCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallGetFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetField(int calledParameters)
         {
         }
      }
   }
