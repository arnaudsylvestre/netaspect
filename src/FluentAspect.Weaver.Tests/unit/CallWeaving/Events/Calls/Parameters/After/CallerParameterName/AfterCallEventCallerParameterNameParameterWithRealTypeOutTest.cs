...
{
    public class AfterCallEventCallerParameterNameParameterWithRealTypeOutTest :
        NetAspectTest<AfterCallEventCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
