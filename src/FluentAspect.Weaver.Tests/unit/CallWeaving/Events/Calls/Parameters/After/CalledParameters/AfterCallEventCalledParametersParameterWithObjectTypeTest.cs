...
{
    public class AfterCallEventCalledParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallEventCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
