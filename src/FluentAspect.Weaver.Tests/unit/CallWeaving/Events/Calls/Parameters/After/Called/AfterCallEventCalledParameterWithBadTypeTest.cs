...
{
    public class AfterCallEventCalledParameterWithBadTypeTest : NetAspectTest<AfterCallEventCalledParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(int called)
         {
         }
      }
   }
