...
{
    public class AfterCallEventCallerParameterNameParameterWithObjectTypeTest :
        NetAspectTest<AfterCallEventCallerParameterNameParameterWithObjectTypeTest.ClassToWeave>
    {
