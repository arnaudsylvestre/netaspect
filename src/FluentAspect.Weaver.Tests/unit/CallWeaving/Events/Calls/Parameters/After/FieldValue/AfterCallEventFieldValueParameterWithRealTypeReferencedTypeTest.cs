...
{
    public class AfterCallEventFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
