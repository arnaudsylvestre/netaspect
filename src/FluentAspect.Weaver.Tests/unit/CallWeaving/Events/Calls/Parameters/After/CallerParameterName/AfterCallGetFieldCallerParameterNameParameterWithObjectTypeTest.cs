...
{
    public class AfterCallGetFieldCallerParameterNameParameterWithObjectTypeTest : NetAspectTest<AfterCallGetFieldCallerParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
