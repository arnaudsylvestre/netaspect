...
{
    public class AfterCallEventFilePathParameterWithBadTypeTest : NetAspectTest<AfterCallEventFilePathParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(int filePath)
         {
             FilePath = filePath;
         }
      }
