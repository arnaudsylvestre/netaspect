...
{
    public class AfterCallEventCalledParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
