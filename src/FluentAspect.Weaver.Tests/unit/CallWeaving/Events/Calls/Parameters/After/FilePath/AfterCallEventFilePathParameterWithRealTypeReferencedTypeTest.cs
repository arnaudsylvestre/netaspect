...
{
    public class AfterCallEventFilePathParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
