...
{
    public class AfterCallEventFieldParameterWithBadTypeTest :
        NetAspectTest<AfterCallEventFieldParameterWithBadTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterRaiseEvent(string field)
            {
            }
        }
    }
