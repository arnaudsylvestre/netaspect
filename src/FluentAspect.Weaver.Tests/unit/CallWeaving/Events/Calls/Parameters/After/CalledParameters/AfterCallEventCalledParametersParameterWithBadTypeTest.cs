...
{
    public class AfterCallEventCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallEventCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(int calledParameters)
         {
         }
      }
   }
