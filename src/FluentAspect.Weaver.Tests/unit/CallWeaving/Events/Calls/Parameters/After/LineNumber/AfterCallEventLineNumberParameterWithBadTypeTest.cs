...
{
    public class AfterCallEventLineNumberParameterWithBadTypeTest : NetAspectTest<AfterCallEventLineNumberParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(string lineNumber)
         {
         }
      }
   }
