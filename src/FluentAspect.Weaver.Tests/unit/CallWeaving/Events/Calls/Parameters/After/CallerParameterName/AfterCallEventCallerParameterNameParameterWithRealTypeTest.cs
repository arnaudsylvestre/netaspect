...
{
    public class AfterCallEventCallerParameterNameParameterWithRealTypeTest :
        NetAspectTest<AfterCallEventCallerParameterNameParameterWithRealTypeTest.ClassToWeave>
    {
