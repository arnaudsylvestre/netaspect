...
{
    public class AfterCallEventColumnNumberParameterWithBadTypeTest : NetAspectTest<AfterCallEventColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(string columnNumber)
         {
         }
      }
   }
