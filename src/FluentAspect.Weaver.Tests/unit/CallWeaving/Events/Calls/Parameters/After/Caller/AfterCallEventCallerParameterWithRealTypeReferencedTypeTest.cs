...
{
    public class AfterCallEventCallerParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
