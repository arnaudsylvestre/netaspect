...
{
    public class AfterCallEventCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref ClassToWeave caller)
         {
         }
      }
   }
