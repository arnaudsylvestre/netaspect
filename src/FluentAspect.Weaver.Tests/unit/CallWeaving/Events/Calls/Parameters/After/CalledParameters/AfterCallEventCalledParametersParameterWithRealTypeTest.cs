...
{
    public class AfterCallEventCalledParametersParameterWithRealTypeTest :
        NetAspectTest<AfterCallEventCalledParametersParameterWithRealTypeTest.ClassToWeave>
    {
