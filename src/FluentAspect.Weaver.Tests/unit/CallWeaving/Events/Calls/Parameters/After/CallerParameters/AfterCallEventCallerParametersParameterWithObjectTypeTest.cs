...
{
    public class AfterCallEventCallerParametersParameterWithObjectTypeTest :
        NetAspectTest<AfterCallEventCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
