...
{
    public class AfterCallGetFieldCallerParametersParameterWithBadTypeTest : NetAspectTest<AfterCallGetFieldCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
