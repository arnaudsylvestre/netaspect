...
{
    public class AfterCallEventColumnNumberParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
