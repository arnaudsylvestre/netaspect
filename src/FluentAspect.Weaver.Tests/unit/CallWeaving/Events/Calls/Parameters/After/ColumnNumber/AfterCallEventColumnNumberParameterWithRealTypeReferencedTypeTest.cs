...
{
    public class AfterCallEventColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref int columnNumber)
         {
         }
      }
   }
