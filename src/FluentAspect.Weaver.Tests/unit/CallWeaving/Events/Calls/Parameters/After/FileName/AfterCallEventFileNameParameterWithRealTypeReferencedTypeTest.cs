...
{
    public class AfterCallEventFileNameParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref string fileName)
         {
         }
      }
   }
