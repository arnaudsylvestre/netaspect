...
{
    public class AfterCallEventFileNameParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
