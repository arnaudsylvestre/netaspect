...
{
    public class AfterCallEventCallerParameterNameParameterWithBadTypeTest :
        NetAspectTest<AfterCallEventCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
