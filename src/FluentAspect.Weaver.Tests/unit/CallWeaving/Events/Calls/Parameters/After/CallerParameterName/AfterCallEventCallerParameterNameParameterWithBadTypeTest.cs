...
{
    public class AfterCallEventCallerParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallEventCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(string callerParam1)
         {
         }
      }
   }
