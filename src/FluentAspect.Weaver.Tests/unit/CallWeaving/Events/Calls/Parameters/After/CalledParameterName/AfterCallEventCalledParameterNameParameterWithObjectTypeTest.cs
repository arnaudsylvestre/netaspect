...
{
    public class AfterCallEventCalledParameterNameParameterWithObjectTypeTest :
        NetAspectTest<AfterCallEventCalledParameterNameParameterWithObjectTypeTest.ClassToWeave>
    {
