...
{
    public class AfterCallEventCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref object[] callerParameters)
         {
         }
      }
   }
