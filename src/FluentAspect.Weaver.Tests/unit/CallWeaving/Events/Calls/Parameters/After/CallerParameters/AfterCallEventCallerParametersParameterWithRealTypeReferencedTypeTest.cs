...
{
    public class AfterCallEventCallerParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
