...
{
    public class AfterCallEventCalledParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallEventCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
