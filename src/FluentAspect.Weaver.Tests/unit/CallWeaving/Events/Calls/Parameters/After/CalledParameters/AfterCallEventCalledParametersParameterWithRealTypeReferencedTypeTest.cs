...
{
    public class AfterCallEventCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref object[] calledParameters)
         {
         }
      }
   }
