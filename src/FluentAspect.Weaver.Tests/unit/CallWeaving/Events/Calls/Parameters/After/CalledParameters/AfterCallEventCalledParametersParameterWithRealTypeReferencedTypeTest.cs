...
{
    public class AfterCallEventCalledParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
