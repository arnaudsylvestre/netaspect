...
{
    public class AfterCallEventFileNameParameterWithBadTypeTest : NetAspectTest<AfterCallEventFileNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(int fileName)
         {
             FileName = fileName;
         }
      }
