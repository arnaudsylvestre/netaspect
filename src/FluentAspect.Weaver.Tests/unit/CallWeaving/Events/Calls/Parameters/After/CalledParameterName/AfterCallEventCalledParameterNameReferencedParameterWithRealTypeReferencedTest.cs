...
{
    public class AfterCallEventCalledParameterNameReferencedParameterWithRealTypeReferencedTest :
        NetAspectTest<AfterCallEventCalledParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
