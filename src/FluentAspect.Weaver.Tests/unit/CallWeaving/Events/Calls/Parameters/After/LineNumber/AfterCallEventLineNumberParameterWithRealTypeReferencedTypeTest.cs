...
{
    public class AfterCallEventLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref int lineNumber)
         {
         }
      }
   }
