...
{
    public class AfterCallEventLineNumberParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
