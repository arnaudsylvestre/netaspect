...
{
    public class AfterCallEventCalledParameterNameReferencedParameterWithRealTypeTest :
        NetAspectTest<AfterCallEventCalledParameterNameReferencedParameterWithRealTypeTest.ClassToWeave>
    {
