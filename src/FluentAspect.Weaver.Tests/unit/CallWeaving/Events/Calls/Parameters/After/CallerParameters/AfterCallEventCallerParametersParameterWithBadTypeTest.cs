...
{
    public class AfterCallEventCallerParametersParameterWithBadTypeTest : NetAspectTest<AfterCallEventCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(int callerParameters)
         {
         }
      }
   }
