...
{
    public class AfterCallEventFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallEventFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterRaiseEvent(ref FieldInfo field)
         {
         }
      }
   }
