...
{
    public class AfterCallEventFieldParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallEventFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
