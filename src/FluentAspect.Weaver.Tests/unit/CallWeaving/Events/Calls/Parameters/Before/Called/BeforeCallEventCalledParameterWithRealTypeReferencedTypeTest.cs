...
{
    public class BeforeCallEventCalledParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
