...
{
    public class BeforeCallEventLineNumberParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
