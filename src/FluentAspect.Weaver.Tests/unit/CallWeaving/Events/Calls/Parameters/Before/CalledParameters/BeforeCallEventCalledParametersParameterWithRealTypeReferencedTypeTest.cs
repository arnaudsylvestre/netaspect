...
{
    public class BeforeCallEventCalledParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
