...
{
    public class BeforeCallEventCalledParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallEventCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
