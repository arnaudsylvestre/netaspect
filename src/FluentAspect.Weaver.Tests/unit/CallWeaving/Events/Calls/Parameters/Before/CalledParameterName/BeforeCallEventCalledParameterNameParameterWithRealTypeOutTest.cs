...
{
    public class BeforeCallEventCalledParameterNameParameterWithRealTypeOutTest :
        NetAspectTest<BeforeCallEventCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
