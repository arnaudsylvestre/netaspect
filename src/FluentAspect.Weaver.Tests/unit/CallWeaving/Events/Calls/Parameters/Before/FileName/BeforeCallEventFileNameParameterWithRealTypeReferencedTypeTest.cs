...
{
    public class BeforeCallEventFileNameParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
