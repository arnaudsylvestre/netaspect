...
{
    public class BeforeCallEventCalledParametersParameterWithRealTypeTest :
        NetAspectTest<BeforeCallEventCalledParametersParameterWithRealTypeTest.ClassToWeave>
    {
