...
{
    public class BeforeCallEventCalledParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallEventCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
