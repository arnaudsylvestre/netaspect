...
{
    public class BeforeCallGetFieldFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetFieldFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
