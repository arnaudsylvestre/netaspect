...
{
    public class BeforeCallEventCallerParametersParameterWithRealTypeTest :
        NetAspectTest<BeforeCallEventCallerParametersParameterWithRealTypeTest.ClassToWeave>
    {
