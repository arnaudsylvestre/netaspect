...
{
    public class BeforeCallEventCalledParameterNameParameterWithRealTypeTest :
        NetAspectTest<BeforeCallEventCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
    {
