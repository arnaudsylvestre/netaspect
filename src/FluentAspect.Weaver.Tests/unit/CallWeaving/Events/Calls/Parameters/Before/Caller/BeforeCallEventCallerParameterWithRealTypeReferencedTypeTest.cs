...
{
    public class BeforeCallEventCallerParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
