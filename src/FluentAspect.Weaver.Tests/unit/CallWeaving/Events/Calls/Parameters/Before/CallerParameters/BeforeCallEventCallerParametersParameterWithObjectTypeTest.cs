...
{
    public class BeforeCallEventCallerParametersParameterWithObjectTypeTest :
        NetAspectTest<BeforeCallEventCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
