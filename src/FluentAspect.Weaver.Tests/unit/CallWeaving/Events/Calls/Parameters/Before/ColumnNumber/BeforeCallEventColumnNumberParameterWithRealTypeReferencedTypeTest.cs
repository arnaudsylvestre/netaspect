...
{
    public class BeforeCallEventColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallEventColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
