...
{
    public class BeforeCallGetFieldCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetFieldCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
