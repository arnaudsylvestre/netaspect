...
{
    public class BeforeCallGetFieldFieldValueParameterWithRealTypeTest : NetAspectTest<BeforeCallGetFieldFieldValueParameterWithRealTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetField(string fieldValue)
         {
