...
{
    public class BeforeCallEventFieldParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
