...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Events.Calls.Parameters.Before.Field
{
    public class BeforeCallEventFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallEventFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref FieldInfo field)
         {
         }
      }
   }
