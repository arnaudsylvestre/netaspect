...
{
    public class BeforeCallEventFilePathParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
