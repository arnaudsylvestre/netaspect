...
{
    public class BeforeCallEventCallerParameterNameParameterWithBadTypeTest :
        NetAspectTest<BeforeCallEventCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
