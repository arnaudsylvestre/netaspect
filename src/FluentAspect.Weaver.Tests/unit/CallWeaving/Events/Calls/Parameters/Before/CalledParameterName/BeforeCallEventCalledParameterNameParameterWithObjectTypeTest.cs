...
{
    public class BeforeCallEventCalledParameterNameParameterWithObjectTypeTest : NetAspectTest<BeforeCallEventCalledParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
