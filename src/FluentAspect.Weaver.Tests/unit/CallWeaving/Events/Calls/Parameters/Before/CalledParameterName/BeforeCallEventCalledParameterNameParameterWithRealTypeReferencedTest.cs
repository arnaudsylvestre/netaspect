...
{
    public class BeforeCallEventCalledParameterNameParameterWithRealTypeReferencedTest :
        NetAspectTest<BeforeCallEventCalledParameterNameParameterWithRealTypeReferencedTest.ClassToWeave>
    {
