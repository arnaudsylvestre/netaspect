...
{
    public class BeforeCallEventCalledParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallEventCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
