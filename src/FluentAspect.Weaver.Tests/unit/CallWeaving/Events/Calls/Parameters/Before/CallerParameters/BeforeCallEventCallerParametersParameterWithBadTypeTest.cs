...
{
    public class BeforeCallEventCallerParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallEventCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
