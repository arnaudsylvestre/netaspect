...
{
    public class BeforeCallEventCallerParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
