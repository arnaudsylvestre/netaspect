...
{
    public class BeforeCallEventFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallEventFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
