...
{
    public class BeforeCallGetFieldFileNameParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetFieldFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
