...
{
    public class AfterCallSubscribeEventCallerParametersParameterWithRealTypeTest :
        NetAspectTest<AfterCallSubscribeEventCallerParametersParameterWithRealTypeTest.ClassToWeave>
    {
