...
{
    public class AfterCallSubscribeEventCallerParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallSubscribeEventCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
