...
{
    public class AfterCallSubscribeEventCalledParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(string calledParam1)
         {
         }
      }
   }
