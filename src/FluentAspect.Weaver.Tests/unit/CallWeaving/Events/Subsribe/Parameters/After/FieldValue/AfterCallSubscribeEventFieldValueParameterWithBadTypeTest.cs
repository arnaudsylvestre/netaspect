...
{
    public class AfterCallSubscribeEventFieldValueParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int fieldValue)
         {
