...
{
    public class AfterCallSubscribeEventFieldValueParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventFieldValueParameterWithBadTypeTest.ClassToWeave>
    {
