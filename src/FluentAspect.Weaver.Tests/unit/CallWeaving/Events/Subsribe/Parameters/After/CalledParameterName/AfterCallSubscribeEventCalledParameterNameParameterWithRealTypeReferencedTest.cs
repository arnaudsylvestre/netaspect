...
{
    public class AfterCallSubscribeEventCalledParameterNameParameterWithRealTypeReferencedTest :
        NetAspectTest<AfterCallSubscribeEventCalledParameterNameParameterWithRealTypeReferencedTest.ClassToWeave>
    {
