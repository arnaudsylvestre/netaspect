...
{
    public class AfterCallSubscribeEventColumnNumberParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(string columnNumber)
         {
         }
      }
   }
