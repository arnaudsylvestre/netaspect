...
{
    public class AfterCallSubscribeEventColumnNumberParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventColumnNumberParameterWithBadTypeTest.ClassToWeave>
    {
