...
{
    public class AfterCallSubscribeEventCalledParametersParameterWithObjectTypeTest :
        NetAspectTest<AfterCallSubscribeEventCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
