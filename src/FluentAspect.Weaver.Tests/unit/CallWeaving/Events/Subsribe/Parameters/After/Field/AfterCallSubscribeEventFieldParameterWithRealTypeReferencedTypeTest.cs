...
{
    public class AfterCallSubscribeEventFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref FieldInfo field)
         {
         }
      }
   }
