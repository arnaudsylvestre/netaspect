...
{
    public class AfterCallSubscribeEventCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref object[] calledParameters)
         {
         }
      }
   }
