...
{
    public class AfterCallSubscribeEventColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
