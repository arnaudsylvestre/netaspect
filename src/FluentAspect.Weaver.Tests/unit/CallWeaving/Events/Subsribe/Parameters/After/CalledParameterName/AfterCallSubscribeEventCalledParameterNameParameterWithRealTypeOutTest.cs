...
{
    public class AfterCallSubscribeEventCalledParameterNameParameterWithRealTypeOutTest : NetAspectTest<AfterCallSubscribeEventCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterSubscribeEvent(out int calledParam1)
            {
                calledParam1 = 12;
            }
        }
