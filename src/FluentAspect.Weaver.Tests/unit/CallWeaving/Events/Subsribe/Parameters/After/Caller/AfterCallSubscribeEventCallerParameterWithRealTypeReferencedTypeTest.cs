...
{
    public class AfterCallSubscribeEventCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref ClassToWeave caller)
         {
         }
      }
   }
