...
{
    public class AfterCallSubscribeEventCallerParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallSubscribeEventCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
