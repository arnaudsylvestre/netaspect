...
{
    public class AfterCallSubscribeEventLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref int lineNumber)
         {
         }
      }
   }
