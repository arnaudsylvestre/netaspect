...
{
    public class AfterCallSubscribeEventLineNumberParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventLineNumberParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(string lineNumber)
         {
         }
      }
   }
