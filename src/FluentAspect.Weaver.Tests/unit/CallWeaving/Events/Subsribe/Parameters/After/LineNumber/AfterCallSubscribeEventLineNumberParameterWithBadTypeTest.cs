...
{
    public class AfterCallSubscribeEventLineNumberParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventLineNumberParameterWithBadTypeTest.ClassToWeave>
    {
