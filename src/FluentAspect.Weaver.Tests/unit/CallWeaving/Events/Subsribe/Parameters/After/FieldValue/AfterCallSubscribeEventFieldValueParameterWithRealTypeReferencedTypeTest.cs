...
{
    public class AfterCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref string fieldValue)
         {
         }
      }
   }
