...
{
    public class AfterCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
