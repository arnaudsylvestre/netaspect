...
{
    public class AfterCallSubscribeEventCalledParametersParameterWithRealTypeTest :
        NetAspectTest<AfterCallSubscribeEventCalledParametersParameterWithRealTypeTest.ClassToWeave>
    {
