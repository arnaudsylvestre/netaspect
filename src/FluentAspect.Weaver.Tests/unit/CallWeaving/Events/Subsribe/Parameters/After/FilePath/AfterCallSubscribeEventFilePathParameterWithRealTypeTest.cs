...
{
    public class AfterCallSubscribeEventFilePathParameterWithRealTypeTest :
        NetAspectTest<AfterCallSubscribeEventFilePathParameterWithRealTypeTest.ClassToWeave>
    {
