...
{
    public class AfterCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref string filePath)
         {
         }
      }
   }
