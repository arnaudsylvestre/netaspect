...
{
    public class AfterCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
