...
{
    public class AfterCallSubscribeEventCalledParameterNameParameterWithRealTypeTest : NetAspectTest<AfterCallSubscribeEventCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
