...
{
    public class AfterCallSubscribeEventCallerParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(string callerParam1)
         {
         }
      }
   }
