...
{
    public class AfterCallSubscribeEventFileNameParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventFileNameParameterWithBadTypeTest.ClassToWeave>
    {
