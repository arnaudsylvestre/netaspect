...
{
    public class AfterCallSubscribeEventFileNameParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventFileNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int fileName)
         {
             FileName = fileName;
         }
      }
