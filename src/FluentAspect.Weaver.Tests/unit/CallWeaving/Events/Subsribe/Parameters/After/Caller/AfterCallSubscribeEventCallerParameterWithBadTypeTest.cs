...
{
    public class AfterCallSubscribeEventCallerParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventCallerParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int caller)
         {
             Caller = caller;
         }
      }
