...
{
    public class AfterCallSubscribeEventCalledParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventCalledParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int called)
         {
         }
      }
   }
