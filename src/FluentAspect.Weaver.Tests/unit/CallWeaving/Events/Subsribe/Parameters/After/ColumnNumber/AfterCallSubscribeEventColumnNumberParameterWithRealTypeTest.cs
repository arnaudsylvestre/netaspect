...
{
    public class AfterCallSubscribeEventColumnNumberParameterWithRealTypeTest : NetAspectTest<AfterCallSubscribeEventColumnNumberParameterWithRealTypeTest.ClassToWeave>
   {
