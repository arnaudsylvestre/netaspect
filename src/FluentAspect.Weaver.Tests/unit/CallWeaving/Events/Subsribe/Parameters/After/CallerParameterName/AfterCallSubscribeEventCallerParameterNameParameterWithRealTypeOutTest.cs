...
{
    public class AfterCallSubscribeEventCallerParameterNameParameterWithRealTypeOutTest : NetAspectTest<AfterCallSubscribeEventCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterSubscribeEvent(out int callerParam1)
            {
                callerParam1 = 12;
            }
        }
