...
{
    [TestFixture]
    public class AfterSubscribeEventColumnNumberParameterTest 
    {
         [Test]
         public void CheckSubscribeEventWithColumnNumberAndNoDebuggingInformation()
         {
          DoUnit.Test(new ClassAndAspectAndCallAcceptanceTestBuilder())
                 .ByDefiningAssembly(simpleClassAndWeaver =>
                    ...
                    .EnsureErrorHandler(e => e.Warnings.Add("The parameter columnNumber in method AfterSubscribeEventValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
                  .AndEnsureAssembly((assembly, actual) =>
                      {
                          var caller = actual.CreateCallerObject();
                          actual.CallCallerMethod(caller);
                          Assert.AreEqual(0, actual.Aspect.AfterSubscribeEventValueColumnNumber);
                      })
                  .AndLaunchTest();
         }
         ...
         public void CheckSubscribeEventWithColumnNumberAndNoDebuggingInformationAndWrongType()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Errors.Add("The parameter columnNumber in method AfterSubscribeEventValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
