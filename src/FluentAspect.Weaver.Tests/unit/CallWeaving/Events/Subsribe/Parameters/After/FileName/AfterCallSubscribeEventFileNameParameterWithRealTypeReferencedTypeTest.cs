...
{
    public class AfterCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
