...
{
    public class AfterCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref string fileName)
         {
         }
      }
   }
