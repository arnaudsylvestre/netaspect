...
{
    public class AfterCallSubscribeEventCalledParametersParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
