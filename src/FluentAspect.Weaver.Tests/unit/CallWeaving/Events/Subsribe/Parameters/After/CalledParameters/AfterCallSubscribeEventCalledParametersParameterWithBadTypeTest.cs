...
{
    public class AfterCallSubscribeEventCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int calledParameters)
         {
         }
      }
   }
