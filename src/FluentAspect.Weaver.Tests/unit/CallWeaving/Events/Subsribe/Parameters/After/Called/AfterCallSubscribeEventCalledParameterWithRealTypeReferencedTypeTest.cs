...
{
    public class AfterCallSubscribeEventCalledParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallSubscribeEventCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(ref ClassToWeave called)
         {
         }
      }
   }
