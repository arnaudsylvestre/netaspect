...
{
    public class AfterCallSubscribeEventCalledParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallSubscribeEventCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
