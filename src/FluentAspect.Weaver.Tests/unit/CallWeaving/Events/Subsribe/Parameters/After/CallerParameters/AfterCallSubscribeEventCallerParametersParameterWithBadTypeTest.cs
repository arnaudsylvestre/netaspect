...
{
    public class AfterCallSubscribeEventCallerParametersParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventCallerParametersParameterWithBadTypeTest.ClassToWeave>
    {
