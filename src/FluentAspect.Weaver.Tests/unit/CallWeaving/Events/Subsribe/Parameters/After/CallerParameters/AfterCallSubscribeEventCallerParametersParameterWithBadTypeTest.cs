...
{
    public class AfterCallSubscribeEventCallerParametersParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int callerParameters)
         {
         }
      }
   }
