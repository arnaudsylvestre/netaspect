...
{
    public class AfterCallSubscribeEventFieldValueParameterWithObjectTypeTest : NetAspectTest<AfterCallSubscribeEventFieldValueParameterWithObjectTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(object fieldValue)
         {
