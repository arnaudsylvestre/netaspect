...
{
    public class AfterCallSubscribeEventFieldValueParameterWithObjectTypeTest :
        NetAspectTest<AfterCallSubscribeEventFieldValueParameterWithObjectTypeTest.ClassToWeave>
    {
