...
{
    public class AfterCallSubscribeEventFilePathParameterWithBadTypeTest :
        NetAspectTest<AfterCallSubscribeEventFilePathParameterWithBadTypeTest.ClassToWeave>
    {
