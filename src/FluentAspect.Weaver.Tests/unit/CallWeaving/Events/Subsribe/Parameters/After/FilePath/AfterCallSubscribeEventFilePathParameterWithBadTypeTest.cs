...
{
    public class AfterCallSubscribeEventFilePathParameterWithBadTypeTest : NetAspectTest<AfterCallSubscribeEventFilePathParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterSubscribeEvent(int filePath)
         {
             FilePath = filePath;
         }
      }
