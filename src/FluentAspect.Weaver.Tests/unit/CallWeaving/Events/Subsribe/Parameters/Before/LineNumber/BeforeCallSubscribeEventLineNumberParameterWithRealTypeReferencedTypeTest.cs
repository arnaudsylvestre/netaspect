...
{
    public class BeforeCallSubscribeEventLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref int lineNumber)
         {
         }
      }
   }
