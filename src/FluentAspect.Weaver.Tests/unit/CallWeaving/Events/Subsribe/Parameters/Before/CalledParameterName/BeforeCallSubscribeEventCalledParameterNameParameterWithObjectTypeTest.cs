...
{
    public class BeforeCallSubscribeEventCalledParameterNameParameterWithObjectTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParameterNameParameterWithObjectTypeTest.ClassToWeave>
    {
