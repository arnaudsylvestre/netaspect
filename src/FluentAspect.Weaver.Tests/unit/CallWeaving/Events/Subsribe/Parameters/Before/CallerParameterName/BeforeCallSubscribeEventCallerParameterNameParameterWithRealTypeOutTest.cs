...
{
    public class BeforeCallSubscribeEventCallerParameterNameParameterWithRealTypeOutTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
