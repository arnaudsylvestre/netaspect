...
{
    public class BeforeCallSubscribeEventCalledParametersParameterWithRealTypeTest : NetAspectTest<BeforeCallSubscribeEventCalledParametersParameterWithRealTypeTest.ClassToWeave>
   {
