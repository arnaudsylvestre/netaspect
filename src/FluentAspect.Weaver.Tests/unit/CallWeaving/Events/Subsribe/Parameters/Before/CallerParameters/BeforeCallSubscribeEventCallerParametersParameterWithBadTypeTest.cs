...
{
    public class BeforeCallSubscribeEventCallerParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(int callerParameters)
         {
         }
      }
   }
