...
{
    public class BeforeCallSubscribeEventLineNumberParameterWithRealTypeTest :
        NetAspectTest<BeforeCallSubscribeEventLineNumberParameterWithRealTypeTest.ClassToWeave>
    {
