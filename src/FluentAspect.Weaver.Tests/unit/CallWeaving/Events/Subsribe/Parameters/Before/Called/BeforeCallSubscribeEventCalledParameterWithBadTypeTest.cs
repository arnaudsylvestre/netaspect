...
{
    public class BeforeCallSubscribeEventCalledParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventCalledParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(int called)
         {
         }
      }
   }
