...
{
    public class BeforeCallSubscribeEventFieldValueParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFieldValueParameterWithBadTypeTest.ClassToWeave>
    {
