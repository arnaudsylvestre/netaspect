...
{
    public class BeforeCallSubscribeEventFieldValueParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(int fieldValue)
         {
