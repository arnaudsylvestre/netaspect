...
{
    public class BeforeCallSubscribeEventCallerParametersParameterWithObjectTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
