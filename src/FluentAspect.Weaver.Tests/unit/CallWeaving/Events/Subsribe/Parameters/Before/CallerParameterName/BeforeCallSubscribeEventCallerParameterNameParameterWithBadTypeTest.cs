...
{
    public class BeforeCallSubscribeEventCallerParameterNameParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
