...
{
    public class BeforeCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
