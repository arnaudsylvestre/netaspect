...
{
    public class BeforeCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref string fieldValue)
         {
         }
      }
   }
