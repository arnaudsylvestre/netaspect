...
{
    public class BeforeCallSubscribeEventColumnNumberParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(string columnNumber)
         {
         }
      }
   }
