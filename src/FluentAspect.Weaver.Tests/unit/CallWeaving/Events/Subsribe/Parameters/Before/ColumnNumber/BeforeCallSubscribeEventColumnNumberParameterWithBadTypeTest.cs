...
{
    public class BeforeCallSubscribeEventColumnNumberParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventColumnNumberParameterWithBadTypeTest.ClassToWeave>
    {
