...
{
    public class BeforeCallSubscribeEventCalledParametersParameterWithObjectTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
