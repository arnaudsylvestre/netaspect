...
{
    public class BeforeCallSubscribeEventFieldParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
