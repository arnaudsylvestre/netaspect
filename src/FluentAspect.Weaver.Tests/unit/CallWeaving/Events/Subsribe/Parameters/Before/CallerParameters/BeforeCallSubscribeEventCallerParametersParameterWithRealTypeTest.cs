...
{
    public class BeforeCallSubscribeEventCallerParametersParameterWithRealTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParametersParameterWithRealTypeTest.ClassToWeave>
    {
