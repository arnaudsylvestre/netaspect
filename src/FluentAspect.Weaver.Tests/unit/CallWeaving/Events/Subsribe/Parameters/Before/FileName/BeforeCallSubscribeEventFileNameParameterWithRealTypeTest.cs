...
{
    public class BeforeCallSubscribeEventFileNameParameterWithRealTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFileNameParameterWithRealTypeTest.ClassToWeave>
    {
