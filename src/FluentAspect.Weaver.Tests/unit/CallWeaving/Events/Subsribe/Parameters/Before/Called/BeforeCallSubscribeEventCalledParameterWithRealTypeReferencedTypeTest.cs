...
{
    public class BeforeCallSubscribeEventCalledParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
