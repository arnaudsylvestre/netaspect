...
{
    public class BeforeCallSubscribeEventCalledParameterNameParameterWithRealTypeOutTest : NetAspectTest<BeforeCallSubscribeEventCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeRaiseEvent(out int calledParam1)
            {
                calledParam1 = 12;
            }
        }
