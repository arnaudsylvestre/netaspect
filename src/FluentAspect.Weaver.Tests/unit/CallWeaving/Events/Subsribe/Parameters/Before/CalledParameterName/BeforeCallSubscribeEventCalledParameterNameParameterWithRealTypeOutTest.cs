...
{
    public class BeforeCallSubscribeEventCalledParameterNameParameterWithRealTypeOutTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
