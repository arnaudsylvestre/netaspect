...
{
    public class BeforeCallSubscribeEventCalledParameterNameParameterWithRealTypeReferencedTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParameterNameParameterWithRealTypeReferencedTest.ClassToWeave>
    {
