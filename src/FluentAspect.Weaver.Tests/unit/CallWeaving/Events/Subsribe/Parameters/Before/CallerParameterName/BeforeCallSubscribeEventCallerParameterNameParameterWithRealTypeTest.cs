...
{
    public class BeforeCallSubscribeEventCallerParameterNameParameterWithRealTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParameterNameParameterWithRealTypeTest.ClassToWeave>
    {
