...
{
    public class BeforeCallSubscribeEventCalledParametersParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
