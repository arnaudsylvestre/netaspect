...
{
    public class BeforeCallSubscribeEventFieldValueParameterWithRealTypeTest : NetAspectTest<BeforeCallSubscribeEventFieldValueParameterWithRealTypeTest.ClassToWeave>
   {
