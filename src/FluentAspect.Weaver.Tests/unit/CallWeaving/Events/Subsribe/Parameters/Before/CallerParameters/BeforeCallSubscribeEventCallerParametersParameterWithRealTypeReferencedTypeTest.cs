...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Events.Subsribe.Parameters.Before.CallerParameters
{
    public class BeforeCallSubscribeEventCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref object[] callerParameters)
         {
         }
      }
   }
