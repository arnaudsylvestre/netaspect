...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Events.Subsribe.Parameters.Before.ColumnNumber
{
    public class BeforeCallSubscribeEventColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref int columnNumber)
         {
         }
      }
   }
