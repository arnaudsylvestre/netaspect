...
{
    public class BeforeCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
