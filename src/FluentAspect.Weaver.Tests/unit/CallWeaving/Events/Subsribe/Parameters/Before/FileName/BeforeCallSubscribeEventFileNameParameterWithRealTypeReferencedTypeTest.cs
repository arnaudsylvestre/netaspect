...
{
    public class BeforeCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref string fileName)
         {
         }
      }
   }
