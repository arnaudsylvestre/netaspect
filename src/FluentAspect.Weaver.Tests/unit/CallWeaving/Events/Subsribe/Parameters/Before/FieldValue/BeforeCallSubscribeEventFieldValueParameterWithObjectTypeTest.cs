...
{
    public class BeforeCallSubscribeEventFieldValueParameterWithObjectTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFieldValueParameterWithObjectTypeTest.ClassToWeave>
    {
