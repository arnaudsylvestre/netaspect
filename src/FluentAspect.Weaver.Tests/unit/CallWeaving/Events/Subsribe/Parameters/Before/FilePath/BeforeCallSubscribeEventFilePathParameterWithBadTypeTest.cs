...
{
    public class BeforeCallSubscribeEventFilePathParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventFilePathParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(int filePath)
         {
             FilePath = filePath;
         }
      }
