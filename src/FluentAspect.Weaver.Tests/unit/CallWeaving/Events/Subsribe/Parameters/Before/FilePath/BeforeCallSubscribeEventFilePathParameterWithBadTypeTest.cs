...
{
    public class BeforeCallSubscribeEventFilePathParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFilePathParameterWithBadTypeTest.ClassToWeave>
    {
