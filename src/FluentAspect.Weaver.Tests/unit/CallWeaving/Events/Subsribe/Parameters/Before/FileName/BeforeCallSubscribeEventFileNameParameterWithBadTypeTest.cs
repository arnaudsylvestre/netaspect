...
{
    public class BeforeCallSubscribeEventFileNameParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventFileNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(int fileName)
         {
             FileName = fileName;
         }
      }
