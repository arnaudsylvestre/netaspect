...
{
    public class BeforeCallSubscribeEventFileNameParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFileNameParameterWithBadTypeTest.ClassToWeave>
    {
