...
{
    public class BeforeCallSubscribeEventCalledParameterNameParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
