...
{
    public class BeforeCallSubscribeEventCalledParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
