...
{
    public class BeforeCallSubscribeEventCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref object[] calledParameters)
         {
         }
      }
   }
