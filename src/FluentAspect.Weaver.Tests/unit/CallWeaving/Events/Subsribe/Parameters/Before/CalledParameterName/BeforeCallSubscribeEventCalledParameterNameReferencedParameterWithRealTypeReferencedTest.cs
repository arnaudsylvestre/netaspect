...
{
    public class BeforeCallSubscribeEventCalledParameterNameReferencedParameterWithRealTypeReferencedTest : NetAspectTest<BeforeCallSubscribeEventCalledParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
