...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Events.Subsribe.Parameters.Before.FilePath
{
    public class BeforeCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(ref string filePath)
         {
         }
      }
   }
