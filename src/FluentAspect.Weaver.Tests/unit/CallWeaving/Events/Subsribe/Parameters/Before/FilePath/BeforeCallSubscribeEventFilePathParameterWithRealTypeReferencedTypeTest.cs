...
{
    public class BeforeCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
