...
{
    public class BeforeCallSubscribeEventCallerParameterNameReferencedParameterWithRealTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParameterNameReferencedParameterWithRealTypeTest.ClassToWeave>
    {
