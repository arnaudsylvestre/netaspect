...
{
    public class BeforeCallSubscribeEventLineNumberParameterWithBadTypeTest :
        NetAspectTest<BeforeCallSubscribeEventLineNumberParameterWithBadTypeTest.ClassToWeave>
    {
