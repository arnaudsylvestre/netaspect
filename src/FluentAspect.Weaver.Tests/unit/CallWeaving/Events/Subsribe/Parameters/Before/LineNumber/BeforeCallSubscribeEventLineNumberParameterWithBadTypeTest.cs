...
{
    public class BeforeCallSubscribeEventLineNumberParameterWithBadTypeTest : NetAspectTest<BeforeCallSubscribeEventLineNumberParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeRaiseEvent(string lineNumber)
         {
         }
      }
   }
