...
{
    public class BeforeCallSubscribeEventCalledParameterWithRealTypeTest : NetAspectTest<BeforeCallSubscribeEventCalledParameterWithRealTypeTest.ClassToWeave>
   {
