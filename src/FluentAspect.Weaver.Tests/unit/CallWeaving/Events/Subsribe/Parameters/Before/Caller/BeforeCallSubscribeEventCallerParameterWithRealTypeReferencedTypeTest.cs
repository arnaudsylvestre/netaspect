...
{
    public class BeforeCallSubscribeEventCallerParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallSubscribeEventCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
