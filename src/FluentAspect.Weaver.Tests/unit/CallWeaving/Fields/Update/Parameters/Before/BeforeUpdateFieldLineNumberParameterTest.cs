...
{
    [TestFixture]
    public class BeforeUpdateFieldLineNumberParameterTest 
    {
         [Test]
         public void CheckUpdateFieldWithLineNumberAndNoDebuggingInformation()
        {
         ...
         public void CheckUpdateFieldWithLineNumberAndNoDebuggingInformationAndWrongType()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Errors.Add("The parameter lineNumber in method BeforeUpdateFieldValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
