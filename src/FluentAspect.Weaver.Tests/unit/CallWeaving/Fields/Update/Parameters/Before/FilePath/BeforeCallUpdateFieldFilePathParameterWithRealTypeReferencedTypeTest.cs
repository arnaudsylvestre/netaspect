...
{
    public class BeforeCallUpdateFieldFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdateFieldFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
