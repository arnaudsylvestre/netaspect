...
{
    public class BeforeCallUpdateFieldFieldValueParameterWithRealTypeTest :
        NetAspectTest<BeforeCallUpdateFieldFieldValueParameterWithRealTypeTest.ClassToWeave>
    {
