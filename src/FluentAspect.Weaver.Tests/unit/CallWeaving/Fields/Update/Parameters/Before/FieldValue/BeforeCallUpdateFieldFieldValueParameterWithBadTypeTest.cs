...
{
    public class BeforeCallUpdateFieldFieldValueParameterWithBadTypeTest :
        NetAspectTest<BeforeCallUpdateFieldFieldValueParameterWithBadTypeTest.ClassToWeave>
    {
