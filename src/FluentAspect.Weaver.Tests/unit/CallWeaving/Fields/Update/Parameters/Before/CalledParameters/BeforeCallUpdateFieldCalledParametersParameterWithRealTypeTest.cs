...
{
    public class BeforeCallUpdateFieldCalledParametersParameterWithRealTypeTest :
        NetAspectTest<BeforeCallUpdateFieldCalledParametersParameterWithRealTypeTest.ClassToWeave>
    {
