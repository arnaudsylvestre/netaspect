...
{
    public class BeforeCallUpdateFieldCallerParameterNameReferencedParameterWithRealTypeReferencedTest : NetAspectTest<BeforeCallUpdateFieldCallerParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
