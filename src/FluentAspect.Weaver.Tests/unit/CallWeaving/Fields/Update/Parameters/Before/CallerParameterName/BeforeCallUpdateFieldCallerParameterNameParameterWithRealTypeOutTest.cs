...
{
    public class BeforeCallUpdateFieldCallerParameterNameParameterWithRealTypeOutTest : NetAspectTest<BeforeCallUpdateFieldCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
