...
{
    public class BeforeCallUpdateFieldLineNumberParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdateFieldLineNumberParameterWithBadTypeTest.ClassToWeave>
   {
