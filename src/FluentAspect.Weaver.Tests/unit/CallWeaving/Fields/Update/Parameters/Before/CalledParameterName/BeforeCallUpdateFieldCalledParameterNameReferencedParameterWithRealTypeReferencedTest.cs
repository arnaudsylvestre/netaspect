...
{
    public class BeforeCallUpdateFieldCalledParameterNameReferencedParameterWithRealTypeReferencedTest :
        NetAspectTest
            <BeforeCallUpdateFieldCalledParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
