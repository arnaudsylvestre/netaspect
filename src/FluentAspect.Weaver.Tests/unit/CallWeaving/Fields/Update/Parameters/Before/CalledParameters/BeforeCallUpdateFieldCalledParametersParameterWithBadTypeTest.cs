...
{
    public class BeforeCallUpdateFieldCalledParametersParameterWithBadTypeTest :
        NetAspectTest<BeforeCallUpdateFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
