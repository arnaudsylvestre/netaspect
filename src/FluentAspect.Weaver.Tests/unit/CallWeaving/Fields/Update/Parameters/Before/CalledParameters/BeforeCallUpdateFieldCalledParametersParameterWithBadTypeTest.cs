...
{
    public class BeforeCallUpdateFieldCalledParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdateFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateField(int calledParameters)
         {
         }
      }
   }
