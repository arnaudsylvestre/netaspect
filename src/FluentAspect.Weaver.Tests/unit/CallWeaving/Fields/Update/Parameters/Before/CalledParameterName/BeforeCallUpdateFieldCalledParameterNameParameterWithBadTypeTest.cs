...
{
    public class BeforeCallUpdateFieldCalledParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdateFieldCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateField(string calledParam1)
         {
         }
      }
   }
