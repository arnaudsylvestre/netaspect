...
{
    public class BeforeCallUpdateFieldFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdateFieldFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateField(ref string fieldValue)
         {
         }
      }
   }
