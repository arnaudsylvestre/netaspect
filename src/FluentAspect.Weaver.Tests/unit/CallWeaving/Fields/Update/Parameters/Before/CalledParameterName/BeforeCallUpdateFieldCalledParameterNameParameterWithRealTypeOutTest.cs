...
{
    public class BeforeCallUpdateFieldCalledParameterNameParameterWithRealTypeOutTest :
        NetAspectTest<BeforeCallUpdateFieldCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
