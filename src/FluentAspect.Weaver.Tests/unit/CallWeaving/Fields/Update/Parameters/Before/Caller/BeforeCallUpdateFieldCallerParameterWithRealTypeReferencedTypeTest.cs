...
{
    public class BeforeCallUpdateFieldCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdateFieldCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
