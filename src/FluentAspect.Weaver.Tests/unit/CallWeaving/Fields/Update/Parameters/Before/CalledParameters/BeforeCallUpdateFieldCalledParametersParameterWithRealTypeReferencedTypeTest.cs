...
{
    public class BeforeCallUpdateFieldCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdateFieldCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateField(ref object[] calledParameters)
         {
         }
      }
   }
