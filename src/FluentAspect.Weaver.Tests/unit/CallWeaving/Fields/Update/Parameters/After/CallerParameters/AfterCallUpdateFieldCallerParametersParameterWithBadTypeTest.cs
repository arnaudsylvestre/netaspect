...
{
    public class AfterCallUpdateFieldCallerParametersParameterWithBadTypeTest : NetAspectTest<AfterCallUpdateFieldCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
