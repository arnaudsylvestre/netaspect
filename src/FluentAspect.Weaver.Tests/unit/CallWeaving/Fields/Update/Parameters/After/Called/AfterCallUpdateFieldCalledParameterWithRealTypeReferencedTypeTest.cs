...
{
    public class AfterCallUpdateFieldCalledParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
