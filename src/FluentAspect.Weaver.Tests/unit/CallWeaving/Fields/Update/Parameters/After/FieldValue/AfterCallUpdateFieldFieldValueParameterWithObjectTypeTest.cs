...
{
    public class AfterCallUpdateFieldFieldValueParameterWithObjectTypeTest :
        NetAspectTest<AfterCallUpdateFieldFieldValueParameterWithObjectTypeTest.ClassToWeave>
    {
