...
{
    public class AfterCallUpdateFieldCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
