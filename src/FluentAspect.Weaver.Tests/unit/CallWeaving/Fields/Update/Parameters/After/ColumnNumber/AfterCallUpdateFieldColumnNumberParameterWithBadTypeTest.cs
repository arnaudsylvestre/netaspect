...
{
    public class AfterCallUpdateFieldColumnNumberParameterWithBadTypeTest : NetAspectTest<AfterCallUpdateFieldColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
