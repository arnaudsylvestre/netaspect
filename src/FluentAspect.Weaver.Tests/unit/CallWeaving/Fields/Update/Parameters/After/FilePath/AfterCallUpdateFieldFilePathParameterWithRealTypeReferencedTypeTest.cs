...
{
    public class AfterCallUpdateFieldFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
