...
{
    public class AfterCallUpdateFieldCalledParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallUpdateFieldCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
