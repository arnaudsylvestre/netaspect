...
{
    public class AfterCallUpdateFieldFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
