...
{
    public class AfterCallUpdateFieldCalledParameterNameParameterWithRealTypeTest : NetAspectTest<AfterCallUpdateFieldCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
