...
{
    public class AfterCallUpdateFieldCalledParametersParameterWithBadTypeTest :
        NetAspectTest<AfterCallUpdateFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
