...
{
    public class AfterCallUpdateFieldCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallUpdateFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterUpdateField(int calledParameters)
         {
         }
      }
   }
