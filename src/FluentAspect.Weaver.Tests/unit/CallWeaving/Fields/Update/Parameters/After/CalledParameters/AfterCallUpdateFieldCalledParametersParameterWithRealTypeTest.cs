...
{
    public class AfterCallUpdateFieldCalledParametersParameterWithRealTypeTest :
        NetAspectTest<AfterCallUpdateFieldCalledParametersParameterWithRealTypeTest.ClassToWeave>
    {
