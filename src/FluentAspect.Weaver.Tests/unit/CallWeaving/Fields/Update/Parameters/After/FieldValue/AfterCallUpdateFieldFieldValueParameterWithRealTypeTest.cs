...
{
    public class AfterCallUpdateFieldFieldValueParameterWithRealTypeTest : NetAspectTest<AfterCallUpdateFieldFieldValueParameterWithRealTypeTest.ClassToWeave>
   {
