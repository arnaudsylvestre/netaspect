...
{
    public class AfterCallUpdateFieldFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
