...
{
    public class AfterCallUpdateFieldCallerParameterNameParameterWithObjectTypeTest : NetAspectTest<AfterCallUpdateFieldCallerParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
