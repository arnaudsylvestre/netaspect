...
{
    public class AfterCallUpdateFieldLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
