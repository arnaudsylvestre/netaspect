...
{
    public class AfterCallUpdateFieldCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
