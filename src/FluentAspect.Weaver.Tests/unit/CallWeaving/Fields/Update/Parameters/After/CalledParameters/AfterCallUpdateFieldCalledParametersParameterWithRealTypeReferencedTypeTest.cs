...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Fields.Update.Parameters.After.CalledParameters
{
    public class AfterCallUpdateFieldCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdateFieldCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterUpdateField(ref object[] calledParameters)
         {
         }
      }
   }
