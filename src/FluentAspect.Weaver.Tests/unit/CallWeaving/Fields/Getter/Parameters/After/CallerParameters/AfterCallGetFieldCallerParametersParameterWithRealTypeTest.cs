...
{
    public class AfterCallGetFieldCallerParametersParameterWithRealTypeTest : NetAspectTest<AfterCallGetFieldCallerParametersParameterWithRealTypeTest.ClassToWeave>
   {
