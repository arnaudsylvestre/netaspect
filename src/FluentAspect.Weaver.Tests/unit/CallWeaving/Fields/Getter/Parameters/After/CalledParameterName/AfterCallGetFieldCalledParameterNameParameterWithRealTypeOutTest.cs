...
{
    public class AfterCallGetFieldCalledParameterNameParameterWithRealTypeOutTest : NetAspectTest<AfterCallGetFieldCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterGetField(out int calledParam1)
            {
                calledParam1 = 12;
            }
        }
