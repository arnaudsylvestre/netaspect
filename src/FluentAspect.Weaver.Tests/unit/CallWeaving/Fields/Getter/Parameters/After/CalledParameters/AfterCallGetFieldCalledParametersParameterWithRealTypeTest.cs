...
{
    public class AfterCallGetFieldCalledParametersParameterWithRealTypeTest :
        NetAspectTest<AfterCallGetFieldCalledParametersParameterWithRealTypeTest.ClassToWeave>
    {
