...
{
    public class AfterCallGetFieldCalledParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallGetFieldCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
