...
{
    public class AfterCallGetFieldFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetFieldFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
