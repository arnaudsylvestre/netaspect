...
{
    public class AfterCallGetFieldCallerParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallGetFieldCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
