...
{
    public class AfterCallGetFieldCalledParametersParameterWithBadTypeTest :
        NetAspectTest<AfterCallGetFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
