...
{
    public class AfterCallGetFieldCallerParameterNameParameterWithRealTypeOutTest : NetAspectTest<AfterCallGetFieldCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
