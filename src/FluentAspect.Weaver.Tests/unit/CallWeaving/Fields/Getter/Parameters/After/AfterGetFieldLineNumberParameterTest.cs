...
{
    [TestFixture]
    public class AfterGetFieldLineNumberParameterTest 
    {
         [Test]
         ...
         public void CheckGetFieldWithLineNumberAndDebuggingInformation()
         {
             ...
             //            Assert.AreEqual(0, actual.Aspect.AfterGetFieldValueLineNumber);
             //        })
             //        .AndLaunchTest();
         }
         ...
         public void CheckGetFieldWithLineNumberAndNoDebuggingInformationAndWrongType()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Errors.Add("The parameter lineNumber in method AfterGetFieldValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
