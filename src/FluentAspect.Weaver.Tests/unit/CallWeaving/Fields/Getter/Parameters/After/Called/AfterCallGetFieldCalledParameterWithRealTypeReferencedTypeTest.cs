...
{
    public class AfterCallGetFieldCalledParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetFieldCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
