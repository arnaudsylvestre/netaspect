...
{
    public class AfterCallGetFieldCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetFieldCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
