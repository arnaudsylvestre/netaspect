...
{
    public class AfterCallGetFieldFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallGetFieldFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
