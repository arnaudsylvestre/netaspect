...
{
    public class AfterCallGetFieldCalledParameterNameReferencedParameterWithRealTypeTest : NetAspectTest<AfterCallGetFieldCalledParameterNameReferencedParameterWithRealTypeTest.ClassToWeave>
    {
