...
{
    public class AfterCallGetFieldCallerParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallGetFieldCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
