...
{
    public class AfterCallGetFieldCalledParameterNameParameterWithRealTypeTest : NetAspectTest<AfterCallGetFieldCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
