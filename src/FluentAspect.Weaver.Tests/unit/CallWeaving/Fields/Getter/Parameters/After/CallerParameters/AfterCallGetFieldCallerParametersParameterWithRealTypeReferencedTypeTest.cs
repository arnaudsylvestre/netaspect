...
{
    public class AfterCallGetFieldCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetFieldCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
