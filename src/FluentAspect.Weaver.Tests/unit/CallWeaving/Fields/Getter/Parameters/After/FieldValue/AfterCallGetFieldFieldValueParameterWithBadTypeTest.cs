...
{
    public class AfterCallGetFieldFieldValueParameterWithBadTypeTest : NetAspectTest<AfterCallGetFieldFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetField(int fieldValue)
         {
