...
{
    public class AfterCallGetFieldCalledParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallGetFieldCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
