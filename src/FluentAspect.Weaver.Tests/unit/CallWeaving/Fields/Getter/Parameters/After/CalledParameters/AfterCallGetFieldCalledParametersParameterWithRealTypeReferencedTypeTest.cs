...
{
    public class AfterCallGetFieldCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetFieldCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetField(ref object[] calledParameters)
         {
         }
      }
   }
