...
{
    public class BeforeCallGetFieldCalledParameterNameParameterWithRealTypeOutTest : NetAspectTest<BeforeCallGetFieldCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeGetField(out int calledParam1)
            {
                calledParam1 = 12;
            }
        }
