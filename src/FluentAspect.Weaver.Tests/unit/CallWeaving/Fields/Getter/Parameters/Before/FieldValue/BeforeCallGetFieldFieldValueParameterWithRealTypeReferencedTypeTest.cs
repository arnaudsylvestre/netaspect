...
{
    public class BeforeCallGetFieldFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallGetFieldFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
