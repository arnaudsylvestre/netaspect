...
{
    public class BeforeCallGetFieldCalledParameterNameParameterWithObjectTypeTest : NetAspectTest<BeforeCallGetFieldCalledParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
