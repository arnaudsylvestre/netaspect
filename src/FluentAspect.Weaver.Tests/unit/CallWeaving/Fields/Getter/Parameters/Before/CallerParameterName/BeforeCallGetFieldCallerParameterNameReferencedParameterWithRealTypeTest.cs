...
{
    public class BeforeCallGetFieldCallerParameterNameReferencedParameterWithRealTypeTest : NetAspectTest<BeforeCallGetFieldCallerParameterNameReferencedParameterWithRealTypeTest.ClassToWeave>
    {
