...
{
    public class BeforeCallGetFieldCallerParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallGetFieldCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
