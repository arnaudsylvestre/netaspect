...
{
    public class BeforeCallGetFieldCallerParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallGetFieldCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
