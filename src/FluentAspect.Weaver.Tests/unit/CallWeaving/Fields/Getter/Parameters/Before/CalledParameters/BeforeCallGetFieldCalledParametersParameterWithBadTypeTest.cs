...
{
    public class BeforeCallGetFieldCalledParametersParameterWithBadTypeTest :
        NetAspectTest<BeforeCallGetFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
