...
{
    public class BeforeCallGetFieldCalledParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallGetFieldCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetField(int calledParameters)
         {
         }
      }
   }
