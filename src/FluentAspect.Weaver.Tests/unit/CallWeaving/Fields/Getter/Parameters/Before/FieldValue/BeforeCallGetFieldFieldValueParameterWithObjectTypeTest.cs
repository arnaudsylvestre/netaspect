...
{
    public class BeforeCallGetFieldFieldValueParameterWithObjectTypeTest : NetAspectTest<BeforeCallGetFieldFieldValueParameterWithObjectTypeTest.ClassToWeave>
   {
