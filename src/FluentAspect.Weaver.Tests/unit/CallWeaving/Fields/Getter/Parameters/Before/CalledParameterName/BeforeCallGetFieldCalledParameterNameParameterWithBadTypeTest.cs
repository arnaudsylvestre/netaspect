...
{
    public class BeforeCallGetFieldCalledParameterNameParameterWithBadTypeTest :
        NetAspectTest<BeforeCallGetFieldCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
