...
{
    public class BeforeCallGetFieldCalledParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallGetFieldCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetField(string calledParam1)
         {
         }
      }
   }
