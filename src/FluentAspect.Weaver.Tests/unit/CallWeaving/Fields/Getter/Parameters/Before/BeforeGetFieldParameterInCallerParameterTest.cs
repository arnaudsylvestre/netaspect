...
{
    [TestFixture]
    public class BeforeGetFieldParameterInCallerParameterTest 
    {
         [Test]
         public void CheckGetFieldWithParameterInCallerAndNoDebuggingInformation()
        {
          ...
          //          })
          //          .EnsureErrorHandler(e => e.Warnings.Add("The parameter parameterInCaller in method BeforeGetFieldValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
          //        .AndEnsureAssembly((assembly, actual) =>
          //            {
          //                var caller = actual.CreateCallerObject();
          //                actual.CallCallerMethod(caller);
          //                Assert.AreEqual(0, actual.Aspect.BeforeGetFieldValueParameterInCaller);
          //            })
          //        .AndLaunchTest();
         }
         ...
         public void CheckGetFieldWithParameterInCallerAndNoDebuggingInformationAndWrongType()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Errors.Add("The parameter parameterInCaller in method BeforeGetFieldValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
