...
{
    public class BeforeCallGetFieldLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetFieldLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
