...
{
    public class BeforeCallGetFieldCalledParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallGetFieldCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
