...
{
    public class BeforeCallGetFieldCalledParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetFieldCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
