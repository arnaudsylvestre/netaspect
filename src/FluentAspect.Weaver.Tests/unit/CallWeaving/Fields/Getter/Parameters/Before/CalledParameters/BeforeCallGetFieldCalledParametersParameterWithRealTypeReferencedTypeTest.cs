...
{
    public class BeforeCallGetFieldCalledParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallGetFieldCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
