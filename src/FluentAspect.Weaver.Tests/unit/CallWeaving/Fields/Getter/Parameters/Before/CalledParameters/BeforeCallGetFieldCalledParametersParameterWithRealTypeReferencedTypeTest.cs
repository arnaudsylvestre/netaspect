...
{
    public class BeforeCallGetFieldCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetFieldCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetField(ref object[] calledParameters)
         {
         }
      }
   }
