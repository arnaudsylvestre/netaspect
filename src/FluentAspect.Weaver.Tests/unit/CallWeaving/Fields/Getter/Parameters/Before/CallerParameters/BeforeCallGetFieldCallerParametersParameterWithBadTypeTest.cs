...
{
    public class BeforeCallGetFieldCallerParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallGetFieldCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
