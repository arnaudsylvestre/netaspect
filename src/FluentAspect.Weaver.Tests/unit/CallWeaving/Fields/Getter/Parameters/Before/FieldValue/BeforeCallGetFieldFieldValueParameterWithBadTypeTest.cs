...
{
    public class BeforeCallGetFieldFieldValueParameterWithBadTypeTest : NetAspectTest<BeforeCallGetFieldFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetField(int fieldValue)
         {
