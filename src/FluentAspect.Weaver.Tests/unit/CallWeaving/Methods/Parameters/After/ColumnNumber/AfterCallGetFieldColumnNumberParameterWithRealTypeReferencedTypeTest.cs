...
{
    public class AfterCallMethodColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallMethodColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
