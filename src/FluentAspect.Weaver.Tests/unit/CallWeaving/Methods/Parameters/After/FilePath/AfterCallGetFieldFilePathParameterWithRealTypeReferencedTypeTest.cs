...
{
    public class AfterCallMethodFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallMethodFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
