...
{
    public class AfterCallMethodCalledParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallMethodCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
