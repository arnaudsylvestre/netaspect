...
{
    public class AfterCallMethodCalledParameterNameReferencedParameterWithRealTypeReferencedTest :
        NetAspectTest<AfterCallMethodCalledParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
