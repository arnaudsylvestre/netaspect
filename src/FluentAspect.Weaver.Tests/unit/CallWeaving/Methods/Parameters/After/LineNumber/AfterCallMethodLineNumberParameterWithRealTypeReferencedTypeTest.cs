...
{
    public class AfterCallMethodLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallMethodLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
