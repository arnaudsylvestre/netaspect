...
{
    public class AfterCallMethodCalledParametersParameterWithObjectTypeTest :
        NetAspectTest<AfterCallMethodCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
