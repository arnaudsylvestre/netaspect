...
{
    public class AfterCallMethodCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallMethodCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
