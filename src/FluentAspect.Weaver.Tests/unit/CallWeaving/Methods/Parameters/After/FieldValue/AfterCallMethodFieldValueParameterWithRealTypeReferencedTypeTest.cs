...
{
    public class AfterCallMethodFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallMethodFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
