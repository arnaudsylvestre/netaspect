...
{
    public class AfterCallMethodFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallMethodFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterCallMethod(ref string fieldValue)
         {
         }
      }
   }
