...
{
    public class AfterCallMethodCallerParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallMethodCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
