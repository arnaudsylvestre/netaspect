...
{
    public class AfterCallMethodCallerParametersParameterWithRealTypeTest :
        NetAspectTest<AfterCallMethodCallerParametersParameterWithRealTypeTest.ClassToWeave>
    {
