...
{
    public class AfterCallMethodCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallMethodCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
