...
{
   public class AfterCallMethodFieldParameterWithBadTypeTest : NetAspectTest<AfterCallMethodFieldParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterCallMethod(string field)
         {
         }
      }
   }
