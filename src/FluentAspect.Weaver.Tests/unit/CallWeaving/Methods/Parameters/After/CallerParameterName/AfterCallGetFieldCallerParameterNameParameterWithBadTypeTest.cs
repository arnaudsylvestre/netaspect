...
{
    public class AfterCallMethodCallerParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallMethodCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
