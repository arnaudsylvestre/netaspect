...
{
    public class BeforeCallMethodCallerParameterNameReferencedParameterWithRealTypeTest : NetAspectTest<BeforeCallMethodCallerParameterNameReferencedParameterWithRealTypeTest.ClassToWeave>
    {
