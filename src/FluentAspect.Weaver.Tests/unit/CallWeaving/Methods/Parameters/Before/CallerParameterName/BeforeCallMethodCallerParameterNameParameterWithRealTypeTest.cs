...
{
    public class BeforeCallMethodCallerParameterNameParameterWithRealTypeTest : NetAspectTest<BeforeCallMethodCallerParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
