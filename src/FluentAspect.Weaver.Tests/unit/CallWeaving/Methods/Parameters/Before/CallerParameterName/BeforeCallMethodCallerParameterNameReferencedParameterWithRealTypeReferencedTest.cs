...
{
    public class BeforeCallMethodCallerParameterNameReferencedParameterWithRealTypeReferencedTest : NetAspectTest<BeforeCallMethodCallerParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
