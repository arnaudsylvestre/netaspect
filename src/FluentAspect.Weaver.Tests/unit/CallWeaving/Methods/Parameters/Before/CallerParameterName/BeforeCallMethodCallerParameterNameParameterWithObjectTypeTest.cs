...
{
    public class BeforeCallMethodCallerParameterNameParameterWithObjectTypeTest : NetAspectTest<BeforeCallMethodCallerParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
