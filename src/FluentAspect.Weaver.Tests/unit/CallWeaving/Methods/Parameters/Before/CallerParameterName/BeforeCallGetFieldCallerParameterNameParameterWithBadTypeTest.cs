...
{
    public class BeforeCallMethodCallerParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
