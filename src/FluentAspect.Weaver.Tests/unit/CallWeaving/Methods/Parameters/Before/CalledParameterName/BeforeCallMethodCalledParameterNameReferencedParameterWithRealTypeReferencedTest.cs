...
{
    public class BeforeCallMethodCalledParameterNameReferencedParameterWithRealTypeReferencedTest : NetAspectTest<BeforeCallMethodCalledParameterNameReferencedParameterWithRealTypeReferencedTest.ClassToWeave>
    {
