...
{
    public class BeforeCallMethodCalledParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
