...
{
    public class BeforeCallMethodCalledParameterNameParameterWithRealTypeOutTest : NetAspectTest<BeforeCallMethodCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
