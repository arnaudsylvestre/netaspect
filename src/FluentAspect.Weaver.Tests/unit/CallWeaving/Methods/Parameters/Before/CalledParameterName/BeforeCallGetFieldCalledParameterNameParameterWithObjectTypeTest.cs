...
{
    public class BeforeCallMethodCalledParameterNameParameterWithObjectTypeTest : NetAspectTest<BeforeCallMethodCalledParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
