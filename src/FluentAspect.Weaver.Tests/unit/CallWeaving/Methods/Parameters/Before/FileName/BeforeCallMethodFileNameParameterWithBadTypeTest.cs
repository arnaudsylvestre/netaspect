...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Methods.Parameters.Before.FileName
{
    public class BeforeCallMethodFileNameParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodFileNameParameterWithBadTypeTest.ClassToWeave>
   {
