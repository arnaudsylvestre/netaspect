...
{
   public class BeforeCallMethodFieldParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodFieldParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeCallMethod(string field)
         {
         }
      }
   }
