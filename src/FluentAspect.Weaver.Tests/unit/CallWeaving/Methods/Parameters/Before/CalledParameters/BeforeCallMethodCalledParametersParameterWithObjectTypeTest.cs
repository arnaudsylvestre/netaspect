...
{
    public class BeforeCallMethodCalledParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallMethodCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
