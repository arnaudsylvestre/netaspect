...
{
    public class BeforeCallMethodCalledParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
