...
{
    public class BeforeCallMethodFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallMethodFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
