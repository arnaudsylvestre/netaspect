...
{
    public class BeforeCallMethodCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallMethodCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
