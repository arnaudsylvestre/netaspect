...
{
    public class BeforeCallMethodFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallMethodFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
