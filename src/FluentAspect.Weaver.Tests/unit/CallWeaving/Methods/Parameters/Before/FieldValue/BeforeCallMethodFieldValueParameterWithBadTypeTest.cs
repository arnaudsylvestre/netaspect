...
{
    public class BeforeCallMethodFieldValueParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeCallMethod(int fieldValue)
         {
