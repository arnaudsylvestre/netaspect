...
{
    public class BeforeCallMethodFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallMethodFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeCallMethod(ref string fieldValue)
         {
         }
      }
   }
