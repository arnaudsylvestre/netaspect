...
{
    public class BeforeCallMethodCallerParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallMethodCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
