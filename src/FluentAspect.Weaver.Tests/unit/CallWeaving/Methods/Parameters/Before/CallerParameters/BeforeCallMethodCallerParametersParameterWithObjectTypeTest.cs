...
{
    public class BeforeCallMethodCallerParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallMethodCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
