...
{
    [TestFixture]
    public class BeforeCallMethodColumnNumberParameterTest 
    {
         [Test]
         ...
         public void CheckCallMethodWithColumnNumberAndDebuggingInformation()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Warnings.Add("The parameter columnNumber in method BeforeCallMethodValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
             //            Assert.AreEqual(0, actual.Aspect.BeforeCallMethodValueColumnNumber);
             //        })
             //        .AndLaunchTest();
         }
         ...
         public void CheckCallMethodWithColumnNumberAndNoDebuggingInformationAndWrongType()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Errors.Add("The parameter columnNumber in method BeforeCallMethodValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
