...
{
    public class AfterCallGetPropertyColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
