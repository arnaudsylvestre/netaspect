...
{
    public class AfterCallGetPropertyCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
