...
{
    public class AfterCallGetPropertyCallerParameterNameParameterWithRealTypeOutTest : NetAspectTest<AfterCallGetPropertyCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
