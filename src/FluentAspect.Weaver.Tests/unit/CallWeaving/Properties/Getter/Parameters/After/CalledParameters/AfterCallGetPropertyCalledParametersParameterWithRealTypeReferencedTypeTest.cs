...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Getter.Parameters.After.CalledParameters
{
    public class AfterCallGetPropertyCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetProperty(ref object[] calledParameters)
         {
         }
      }
   }
