...
{
    public class AfterCallGetPropertyCallerParametersParameterWithBadTypeTest : NetAspectTest<AfterCallGetPropertyCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
