...
{
    public class AfterCallGetPropertyFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
