...
{
    public class AfterCallGetPropertyCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallGetPropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetProperty(int calledParameters)
         {
         }
      }
   }
