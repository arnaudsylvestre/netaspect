...
{
    public class AfterCallGetPropertyCalledParametersParameterWithBadTypeTest :
        NetAspectTest<AfterCallGetPropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
