...
{
    public class AfterCallGetPropertyCalledParameterNameParameterWithBadTypeTest :
        NetAspectTest<AfterCallGetPropertyCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterGetProperty(string calledParam1)
            {
            }
        }
    }
