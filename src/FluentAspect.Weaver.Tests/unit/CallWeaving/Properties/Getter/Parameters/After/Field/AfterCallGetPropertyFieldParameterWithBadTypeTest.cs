...
{
   public class AfterCallGetPropertyFieldParameterWithBadTypeTest : NetAspectTest<AfterCallGetPropertyFieldParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetProperty(string field)
         {
         }
      }
   }
