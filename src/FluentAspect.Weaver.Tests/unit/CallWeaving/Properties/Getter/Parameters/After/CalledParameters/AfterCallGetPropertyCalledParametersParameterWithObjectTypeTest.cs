...
{
    public class AfterCallGetPropertyCalledParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallGetPropertyCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
