...
{
    public class AfterCallGetPropertyCallerParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallGetPropertyCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
