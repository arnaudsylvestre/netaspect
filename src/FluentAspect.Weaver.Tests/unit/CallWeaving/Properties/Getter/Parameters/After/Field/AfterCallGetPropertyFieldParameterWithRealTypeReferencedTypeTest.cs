...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Getter.Parameters.After.Field
{
    public class AfterCallGetPropertyFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterGetProperty(ref FieldInfo field)
         {
         }
      }
   }
