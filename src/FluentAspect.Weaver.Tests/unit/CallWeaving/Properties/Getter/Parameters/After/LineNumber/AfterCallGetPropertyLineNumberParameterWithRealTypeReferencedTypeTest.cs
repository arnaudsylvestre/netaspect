...
{
    public class AfterCallGetPropertyLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
