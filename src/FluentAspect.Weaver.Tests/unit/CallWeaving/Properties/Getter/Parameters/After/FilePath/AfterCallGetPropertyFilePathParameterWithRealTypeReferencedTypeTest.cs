...
{
    public class AfterCallGetPropertyFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallGetPropertyFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
