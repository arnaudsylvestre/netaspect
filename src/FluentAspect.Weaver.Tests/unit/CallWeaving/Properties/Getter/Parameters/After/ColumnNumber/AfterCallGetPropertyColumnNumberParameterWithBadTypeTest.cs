...
{
    public class AfterCallGetPropertyColumnNumberParameterWithBadTypeTest : NetAspectTest<AfterCallGetPropertyColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
