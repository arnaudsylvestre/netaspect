...
{
    public class AfterCallGetPropertyCallerParametersParameterWithObjectTypeTest : NetAspectTest<AfterCallGetPropertyCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
