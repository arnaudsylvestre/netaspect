...
{
    [TestFixture]
    public class AfterGetPropertyCallerParameterTest 
    {
         [Test]
         public void CheckGetPropertyWithCallerAndNoDebuggingInformation()
         {
          DoUnit.Test(new ClassAndAspectAndCallAcceptanceTestBuilder())
                 .ByDefiningAssembly(simpleClassAndWeaver =>
                    ...
                    .EnsureErrorHandler(e => e.Warnings.Add("The parameter caller in method AfterGetPropertyValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
                  .AndEnsureAssembly((assembly, actual) =>
                      {
                          var caller = actual.CreateCallerObject();
                          actual.CallCallerMethod(caller);
                          Assert.AreEqual(0, actual.Aspect.AfterGetPropertyValueCaller);
                      })
                  .AndLaunchTest();
         }
         ...
         public void CheckGetPropertyWithCallerAndNoDebuggingInformationAndWrongType()
         {
             ...
             //       })
             //          .EnsureErrorHandler(e => e.Errors.Add("The parameter caller in method AfterGetPropertyValue of type A.MyAspectAttribute will have the default value because there is no debugging information"))
             //        .AndEnsureAssembly((assembly, actual) =>
             //        {
             //            var caller = actual.CreateCallerObject();
             //            actual.CallCallerMethod(caller);
