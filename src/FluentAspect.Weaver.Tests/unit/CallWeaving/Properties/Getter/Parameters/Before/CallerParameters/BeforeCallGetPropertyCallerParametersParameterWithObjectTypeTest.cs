...
{
    public class BeforeCallGetPropertyCallerParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallGetPropertyCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
