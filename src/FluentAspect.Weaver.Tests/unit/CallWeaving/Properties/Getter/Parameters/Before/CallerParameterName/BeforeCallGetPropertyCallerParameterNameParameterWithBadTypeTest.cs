...
{
    public class BeforeCallGetPropertyCallerParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallGetPropertyCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
