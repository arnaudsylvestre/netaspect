...
namespace NetAspect.Weaver.Tests.unit.CallWeaving.Properties.Getter.Parameters.Before.FieldValue
{
    public class BeforeCallGetPropertyFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallGetPropertyFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeGetProperty(ref string fieldValue)
            {
            }
        }
    }
