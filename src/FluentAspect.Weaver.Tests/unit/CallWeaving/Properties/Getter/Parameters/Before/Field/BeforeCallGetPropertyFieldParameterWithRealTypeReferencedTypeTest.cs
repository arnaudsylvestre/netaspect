...
{
    public class BeforeCallGetPropertyFieldParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallGetPropertyFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
