...
{
    public class BeforeCallGetPropertyCalledParametersParameterWithObjectTypeTest :
        NetAspectTest<BeforeCallGetPropertyCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
