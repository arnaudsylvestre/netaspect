...
{
    public class BeforeCallGetPropertyLineNumberParameterWithBadTypeTest : NetAspectTest<BeforeCallGetPropertyLineNumberParameterWithBadTypeTest.ClassToWeave>
   {
