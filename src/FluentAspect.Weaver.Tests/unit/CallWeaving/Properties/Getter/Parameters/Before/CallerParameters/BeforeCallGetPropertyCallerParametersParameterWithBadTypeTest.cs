...
{
    public class BeforeCallGetPropertyCallerParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallGetPropertyCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
