...
{
    public class BeforeCallGetPropertyCalledParametersParameterWithBadTypeTest :
        NetAspectTest<BeforeCallGetPropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
