...
{
    public class BeforeCallGetPropertyCalledParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallGetPropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetProperty(int calledParameters)
         {
         }
      }
   }
