...
{
    public class BeforeCallGetPropertyCalledParametersParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallGetPropertyCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
