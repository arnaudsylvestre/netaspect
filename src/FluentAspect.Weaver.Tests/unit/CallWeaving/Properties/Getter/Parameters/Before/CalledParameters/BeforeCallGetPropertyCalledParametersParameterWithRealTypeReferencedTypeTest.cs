...
{
    public class BeforeCallGetPropertyCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetPropertyCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetProperty(ref object[] calledParameters)
         {
         }
      }
   }
