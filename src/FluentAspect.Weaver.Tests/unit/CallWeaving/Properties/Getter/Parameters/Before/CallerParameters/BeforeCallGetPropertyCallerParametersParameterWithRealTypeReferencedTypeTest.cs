...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Getter.Parameters.Before.CallerParameters
{
    public class BeforeCallGetPropertyCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetPropertyCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetProperty(ref object[] callerParameters)
         {
         }
      }
   }
