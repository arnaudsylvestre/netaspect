...
{
    public class BeforeCallGetPropertyCalledParameterNameParameterWithRealTypeTest : NetAspectTest<BeforeCallGetPropertyCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
