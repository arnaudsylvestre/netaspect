...
{
    public class BeforeCallGetPropertyFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetPropertyFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
