...
{
    public class BeforeCallGetPropertyFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetPropertyFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
