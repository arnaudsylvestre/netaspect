...
{
    public class BeforeCallGetPropertyColumnNumberParameterWithBadTypeTest : NetAspectTest<BeforeCallGetPropertyColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
