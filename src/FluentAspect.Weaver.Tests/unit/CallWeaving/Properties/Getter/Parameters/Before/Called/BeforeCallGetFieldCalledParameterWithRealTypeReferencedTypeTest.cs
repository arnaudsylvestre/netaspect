...
{
    public class BeforeCallGetPropertyCalledParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetPropertyCalledParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
