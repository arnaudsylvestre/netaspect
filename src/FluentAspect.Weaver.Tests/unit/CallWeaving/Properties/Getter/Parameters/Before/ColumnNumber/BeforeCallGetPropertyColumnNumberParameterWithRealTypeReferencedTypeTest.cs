...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Getter.Parameters.Before.ColumnNumber
{
    public class BeforeCallGetPropertyColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallGetPropertyColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetProperty(ref int columnNumber)
         {
         }
      }
   }
