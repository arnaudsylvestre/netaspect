...
{
    public class BeforeCallGetPropertyColumnNumberParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<BeforeCallGetPropertyColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
