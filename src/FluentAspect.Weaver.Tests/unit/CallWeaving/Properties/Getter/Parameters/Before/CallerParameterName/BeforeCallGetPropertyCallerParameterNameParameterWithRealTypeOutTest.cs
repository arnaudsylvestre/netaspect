...
{
    public class BeforeCallGetPropertyCallerParameterNameParameterWithRealTypeOutTest : NetAspectTest<BeforeCallGetPropertyCallerParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
