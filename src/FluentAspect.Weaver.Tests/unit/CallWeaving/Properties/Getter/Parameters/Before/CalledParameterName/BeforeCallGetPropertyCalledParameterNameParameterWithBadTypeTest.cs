...
{
    public class BeforeCallGetPropertyCalledParameterNameParameterWithBadTypeTest :
        NetAspectTest<BeforeCallGetPropertyCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
