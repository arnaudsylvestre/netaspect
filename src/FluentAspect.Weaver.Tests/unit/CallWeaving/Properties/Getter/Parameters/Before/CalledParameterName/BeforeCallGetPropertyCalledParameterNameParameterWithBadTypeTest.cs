...
{
    public class BeforeCallGetPropertyCalledParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallGetPropertyCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeGetProperty(string calledParam1)
         {
         }
      }
   }
