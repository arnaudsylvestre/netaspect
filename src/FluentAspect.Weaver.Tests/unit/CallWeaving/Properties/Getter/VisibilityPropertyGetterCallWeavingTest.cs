...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Getter
{
    [TestFixture]
    public class VisibilityPropertyGetterCallWeavingTest
    {
        [Test]
        ...
        [Test]
        public void CheckCallerPrivate()
        {
            throw new NotImplementedException();
        }
