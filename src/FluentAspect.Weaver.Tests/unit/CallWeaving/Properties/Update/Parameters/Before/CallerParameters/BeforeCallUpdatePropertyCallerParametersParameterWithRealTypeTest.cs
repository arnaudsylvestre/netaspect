...
{
    public class BeforeCallUpdatePropertyCallerParametersParameterWithRealTypeTest : NetAspectTest<BeforeCallUpdatePropertyCallerParametersParameterWithRealTypeTest.ClassToWeave>
   {
