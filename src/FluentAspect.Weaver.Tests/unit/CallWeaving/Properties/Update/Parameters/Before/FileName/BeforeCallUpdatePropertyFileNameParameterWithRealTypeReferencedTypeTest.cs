...
{
    public class BeforeCallUpdatePropertyFileNameParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdatePropertyFileNameParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
