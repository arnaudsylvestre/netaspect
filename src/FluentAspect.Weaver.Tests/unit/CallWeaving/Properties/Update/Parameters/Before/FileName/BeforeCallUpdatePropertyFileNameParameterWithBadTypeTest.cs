...
{
    public class BeforeCallUpdatePropertyFileNameParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdatePropertyFileNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateProperty(int fileName)
         {
             FileName = fileName;
         }
      }
