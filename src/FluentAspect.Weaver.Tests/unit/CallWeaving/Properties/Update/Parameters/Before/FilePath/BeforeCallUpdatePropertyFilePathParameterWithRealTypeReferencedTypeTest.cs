...
{
    public class BeforeCallUpdatePropertyFilePathParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdatePropertyFilePathParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
