...
{
    public class BeforeCallUpdatePropertyFieldParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdatePropertyFieldParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateProperty(ref FieldInfo field)
         {
         }
      }
   }
