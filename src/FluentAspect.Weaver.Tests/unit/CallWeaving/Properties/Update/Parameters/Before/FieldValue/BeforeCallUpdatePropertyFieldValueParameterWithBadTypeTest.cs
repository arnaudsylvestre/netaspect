...
{
    public class BeforeCallUpdatePropertyFieldValueParameterWithBadTypeTest :
        NetAspectTest<BeforeCallUpdatePropertyFieldValueParameterWithBadTypeTest.ClassToWeave>
    {
