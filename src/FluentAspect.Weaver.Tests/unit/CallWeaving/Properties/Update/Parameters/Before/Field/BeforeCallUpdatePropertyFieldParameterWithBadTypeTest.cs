...
{
   public class BeforeCallUpdatePropertyFieldParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdatePropertyFieldParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateProperty(string field)
         {
         }
      }
   }
