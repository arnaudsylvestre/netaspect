...
{
    public class BeforeCallUpdatePropertyFileNameParameterWithRealTypeTest : NetAspectTest<BeforeCallUpdatePropertyFileNameParameterWithRealTypeTest.ClassToWeave>
   {
