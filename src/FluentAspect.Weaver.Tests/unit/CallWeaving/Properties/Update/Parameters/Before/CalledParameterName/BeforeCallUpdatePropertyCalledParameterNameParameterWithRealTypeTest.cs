...
{
    public class BeforeCallUpdatePropertyCalledParameterNameParameterWithRealTypeTest : NetAspectTest<BeforeCallUpdatePropertyCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
