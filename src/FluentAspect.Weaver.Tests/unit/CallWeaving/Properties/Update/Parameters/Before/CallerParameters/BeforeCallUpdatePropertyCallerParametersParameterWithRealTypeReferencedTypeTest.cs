...
{
    public class BeforeCallUpdatePropertyCallerParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdatePropertyCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
