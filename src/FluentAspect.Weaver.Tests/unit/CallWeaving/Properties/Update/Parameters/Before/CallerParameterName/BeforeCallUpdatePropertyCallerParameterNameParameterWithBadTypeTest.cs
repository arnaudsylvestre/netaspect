...
{
    public class BeforeCallUpdatePropertyCallerParameterNameParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdatePropertyCallerParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
