...
{
    public class BeforeCallUpdatePropertyCalledParameterNameParameterWithObjectTypeTest : NetAspectTest<BeforeCallUpdatePropertyCalledParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
