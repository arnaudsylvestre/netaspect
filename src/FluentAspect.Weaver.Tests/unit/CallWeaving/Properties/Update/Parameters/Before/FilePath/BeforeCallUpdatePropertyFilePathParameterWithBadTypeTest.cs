...
{
    public class BeforeCallUpdatePropertyFilePathParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdatePropertyFilePathParameterWithBadTypeTest.ClassToWeave>
   {
