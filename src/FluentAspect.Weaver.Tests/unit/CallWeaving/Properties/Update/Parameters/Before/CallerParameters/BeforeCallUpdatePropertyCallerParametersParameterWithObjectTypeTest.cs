...
{
    public class BeforeCallUpdatePropertyCallerParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallUpdatePropertyCallerParametersParameterWithObjectTypeTest.ClassToWeave>
    {
