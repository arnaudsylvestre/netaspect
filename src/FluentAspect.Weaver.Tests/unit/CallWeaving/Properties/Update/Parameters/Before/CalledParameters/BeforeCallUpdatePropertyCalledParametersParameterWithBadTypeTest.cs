...
{
    public class BeforeCallUpdatePropertyCalledParametersParameterWithBadTypeTest : NetAspectTest<BeforeCallUpdatePropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateProperty(int calledParameters)
         {
         }
      }
   }
