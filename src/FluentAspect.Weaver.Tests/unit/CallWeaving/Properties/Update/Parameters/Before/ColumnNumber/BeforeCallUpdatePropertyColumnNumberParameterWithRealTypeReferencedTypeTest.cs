...
{
    public class BeforeCallUpdatePropertyColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdatePropertyColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateProperty(ref int columnNumber)
         {
         }
      }
   }
