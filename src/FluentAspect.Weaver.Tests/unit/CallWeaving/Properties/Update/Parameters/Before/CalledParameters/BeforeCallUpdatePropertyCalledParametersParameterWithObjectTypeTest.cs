...
{
    public class BeforeCallUpdatePropertyCalledParametersParameterWithObjectTypeTest : NetAspectTest<BeforeCallUpdatePropertyCalledParametersParameterWithObjectTypeTest.ClassToWeave>
    {
