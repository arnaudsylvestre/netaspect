...
{
    public class BeforeCallUpdatePropertyCalledParameterNameParameterWithRealTypeOutTest : NetAspectTest<BeforeCallUpdatePropertyCalledParameterNameParameterWithRealTypeOutTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeUpdateProperty(out int calledParam1)
            {
                calledParam1 = 12;
            }
        }
