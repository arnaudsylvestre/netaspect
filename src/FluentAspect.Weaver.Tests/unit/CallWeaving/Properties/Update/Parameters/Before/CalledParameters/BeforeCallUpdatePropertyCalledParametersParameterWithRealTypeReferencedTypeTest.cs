...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Update.Parameters.Before.CalledParameters
{
    public class BeforeCallUpdatePropertyCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<BeforeCallUpdatePropertyCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void BeforeUpdateProperty(ref object[] calledParameters)
         {
         }
      }
   }
