...
{
    public class AfterCallUpdatePropertyCallerParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdatePropertyCallerParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
