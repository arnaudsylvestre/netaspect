...
namespace FluentAspect.Weaver.Tests.unit.CallWeaving.Properties.Update.Parameters.After.ColumnNumber
{
    public class AfterCallUpdatePropertyColumnNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdatePropertyColumnNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterUpdateProperty(ref int columnNumber)
         {
         }
      }
   }
