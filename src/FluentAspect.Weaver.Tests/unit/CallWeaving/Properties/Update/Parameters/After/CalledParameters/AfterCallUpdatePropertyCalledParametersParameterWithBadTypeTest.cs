...
{
    public class AfterCallUpdatePropertyCalledParametersParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
   {
