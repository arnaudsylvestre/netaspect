...
{
    public class AfterCallUpdatePropertyCalledParametersParameterWithBadTypeTest :
        NetAspectTest<AfterCallUpdatePropertyCalledParametersParameterWithBadTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterUpdateProperty(int calledParameters)
            {
            }
        }
    }
