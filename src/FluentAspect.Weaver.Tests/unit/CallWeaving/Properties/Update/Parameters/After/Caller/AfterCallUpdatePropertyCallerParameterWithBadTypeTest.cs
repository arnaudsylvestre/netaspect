...
namespace NetAspect.Weaver.Tests.unit.CallWeaving.Properties.Update.Parameters.After.Caller
{
        ...
        NetAspectTest<AfterCallUpdatePropertyCallerParameterWithBadTypeTest.ClassToWeave>
    {
        protected override Action<ErrorHandler> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "the caller parameter in the method AfterUpdateProperty of the type '{0}' is declared with the type 'System.Int32' but it is expected to be System.Object or {1}",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterUpdateProperty(int caller)
            {
                Caller = caller;
            }
        }
