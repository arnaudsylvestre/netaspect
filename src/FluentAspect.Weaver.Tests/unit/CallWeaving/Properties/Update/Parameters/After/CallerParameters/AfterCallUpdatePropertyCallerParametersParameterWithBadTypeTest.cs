...
{
    public class AfterCallUpdatePropertyCallerParametersParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyCallerParametersParameterWithBadTypeTest.ClassToWeave>
   {
