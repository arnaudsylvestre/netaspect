...
{
    public class AfterCallUpdatePropertyCallerParametersParameterWithRealTypeTest : NetAspectTest<AfterCallUpdatePropertyCallerParametersParameterWithRealTypeTest.ClassToWeave>
   {
