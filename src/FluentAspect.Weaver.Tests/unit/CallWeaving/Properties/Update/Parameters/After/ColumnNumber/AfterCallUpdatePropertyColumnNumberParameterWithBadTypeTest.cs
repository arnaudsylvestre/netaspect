...
{
    public class AfterCallUpdatePropertyColumnNumberParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyColumnNumberParameterWithBadTypeTest.ClassToWeave>
   {
