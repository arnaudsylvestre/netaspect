...
{
    public class AfterCallUpdatePropertyCalledParameterNameParameterWithRealTypeTest : NetAspectTest<AfterCallUpdatePropertyCalledParameterNameParameterWithRealTypeTest.ClassToWeave>
   {
