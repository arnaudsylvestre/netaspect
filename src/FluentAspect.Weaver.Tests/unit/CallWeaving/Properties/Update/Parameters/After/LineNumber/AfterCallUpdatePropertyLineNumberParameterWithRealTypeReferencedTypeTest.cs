...
{
    public class AfterCallUpdatePropertyLineNumberParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdatePropertyLineNumberParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterUpdateProperty(ref int lineNumber)
         {
         }
      }
   }
