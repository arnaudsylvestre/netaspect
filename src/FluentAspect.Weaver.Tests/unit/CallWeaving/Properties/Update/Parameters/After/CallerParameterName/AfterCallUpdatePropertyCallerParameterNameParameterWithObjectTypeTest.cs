...
{
    public class AfterCallUpdatePropertyCallerParameterNameParameterWithObjectTypeTest : NetAspectTest<AfterCallUpdatePropertyCallerParameterNameParameterWithObjectTypeTest.ClassToWeave>
   {
