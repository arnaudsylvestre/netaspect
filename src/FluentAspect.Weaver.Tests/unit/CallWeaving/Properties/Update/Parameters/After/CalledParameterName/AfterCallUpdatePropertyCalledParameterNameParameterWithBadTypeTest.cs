...
{
    public class AfterCallUpdatePropertyCalledParameterNameParameterWithBadTypeTest :
        NetAspectTest<AfterCallUpdatePropertyCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
