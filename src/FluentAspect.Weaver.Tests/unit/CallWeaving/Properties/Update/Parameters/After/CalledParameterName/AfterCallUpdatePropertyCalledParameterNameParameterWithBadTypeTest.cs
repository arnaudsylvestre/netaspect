...
{
    public class AfterCallUpdatePropertyCalledParameterNameParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterUpdateProperty(string calledParam1)
         {
         }
      }
   }
