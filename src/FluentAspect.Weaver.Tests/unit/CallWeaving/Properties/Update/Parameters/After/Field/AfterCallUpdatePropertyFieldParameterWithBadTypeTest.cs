...
{
   public class AfterCallUpdatePropertyFieldParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyFieldParameterWithBadTypeTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterUpdateProperty(string field)
         {
         }
      }
   }
