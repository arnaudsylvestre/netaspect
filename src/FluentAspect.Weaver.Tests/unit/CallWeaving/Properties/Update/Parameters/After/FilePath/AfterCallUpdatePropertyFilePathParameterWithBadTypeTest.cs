...
{
    public class AfterCallUpdatePropertyFilePathParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyFilePathParameterWithBadTypeTest.ClassToWeave>
   {
