...
{
    public class AfterCallUpdatePropertyFieldValueParameterWithRealTypeTest : NetAspectTest<AfterCallUpdatePropertyFieldValueParameterWithRealTypeTest.ClassToWeave>
   {
