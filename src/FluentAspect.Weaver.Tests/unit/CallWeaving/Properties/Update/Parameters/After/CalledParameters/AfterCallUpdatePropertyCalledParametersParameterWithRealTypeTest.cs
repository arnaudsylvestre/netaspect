...
{
    public class AfterCallUpdatePropertyCalledParametersParameterWithRealTypeTest : NetAspectTest<AfterCallUpdatePropertyCalledParametersParameterWithRealTypeTest.ClassToWeave>
   {
