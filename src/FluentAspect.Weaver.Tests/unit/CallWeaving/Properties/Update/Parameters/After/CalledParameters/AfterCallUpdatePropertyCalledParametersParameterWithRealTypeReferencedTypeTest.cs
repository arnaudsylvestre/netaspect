...
{
    public class AfterCallUpdatePropertyCalledParametersParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdatePropertyCalledParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
