...
{
    public class AfterCallUpdatePropertyFieldValueParameterWithBadTypeTest :
        NetAspectTest<AfterCallUpdatePropertyFieldValueParameterWithBadTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterUpdateProperty(int fieldValue)
            {
