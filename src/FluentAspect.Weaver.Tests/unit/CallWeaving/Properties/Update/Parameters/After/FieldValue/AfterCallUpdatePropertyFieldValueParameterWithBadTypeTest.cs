...
{
    public class AfterCallUpdatePropertyFieldValueParameterWithBadTypeTest : NetAspectTest<AfterCallUpdatePropertyFieldValueParameterWithBadTypeTest.ClassToWeave>
   {
