...
{
    public class AfterCallUpdatePropertyFieldValueParameterWithRealTypeReferencedTypeTest : NetAspectTest<AfterCallUpdatePropertyFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
   {
