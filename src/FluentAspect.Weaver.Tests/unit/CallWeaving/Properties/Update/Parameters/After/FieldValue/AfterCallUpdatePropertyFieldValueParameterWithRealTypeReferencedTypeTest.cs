...
namespace NetAspect.Weaver.Tests.unit.CallWeaving.Properties.Update.Parameters.After.FieldValue
{
    public class AfterCallUpdatePropertyFieldValueParameterWithRealTypeReferencedTypeTest :
        NetAspectTest<AfterCallUpdatePropertyFieldValueParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterUpdateProperty(ref string fieldValue)
            {
            }
        }
    }
