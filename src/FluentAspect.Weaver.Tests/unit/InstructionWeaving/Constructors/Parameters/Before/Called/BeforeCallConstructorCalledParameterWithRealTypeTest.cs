...
{
    public class BeforeCallConstructorCalledParameterWithRealTypeTest :
        NetAspectTest<BeforeCallConstructorCalledParameterWithRealTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeCallConstructor(ClassToWeave called)
            {
                Called = called;
            }
        }
