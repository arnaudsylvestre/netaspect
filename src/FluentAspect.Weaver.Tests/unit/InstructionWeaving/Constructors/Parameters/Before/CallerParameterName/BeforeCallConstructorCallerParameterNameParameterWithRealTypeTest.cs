...
{
    public class BeforeCallConstructorCallerParameterNameParameterWithRealTypeTest :
        NetAspectTest<BeforeCallConstructorCallerParameterNameParameterWithRealTypeTest.ClassToWeave>
    {
