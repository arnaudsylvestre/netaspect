...
namespace NetAspect.Weaver.Tests.unit.CallWeaving.Methods.Parameters.Before.CalledParameterName
{
        ...
        NetAspectTest<BeforeCallMethodCalledParameterNameParameterWithBadTypeTest.ClassToWeave>
    {
        protected override Action<ErrorHandler> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "the calledParam1 parameter in the method BeforeCallMethod of the type '{0}' is declared with the type 'System.String' but it is expected to be System.Int32 because of the type of this parameter in the method Method of the type {1}",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeCallMethod(string calledParam1)
            {
            }
        }
    }
