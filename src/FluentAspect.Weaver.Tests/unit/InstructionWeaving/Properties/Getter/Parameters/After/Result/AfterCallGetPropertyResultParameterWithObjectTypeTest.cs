...
{
    public class AfterCallGetPropertyResultParameterWithObjectTypeTest :
        NetAspectTest<AfterCallGetPropertyResultParameterWithObjectTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterGetProperty(object result)
            {
