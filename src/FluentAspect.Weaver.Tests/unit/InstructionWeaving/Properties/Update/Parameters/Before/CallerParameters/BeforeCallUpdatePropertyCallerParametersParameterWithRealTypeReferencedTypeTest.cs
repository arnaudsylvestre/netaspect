...
namespace NetAspect.Weaver.Tests.unit.InstructionWeaving.Properties.Update.Parameters.Before.CallerParameters
{
        ...
        NetAspectTest<BeforeCallUpdatePropertyCallerParametersParameterWithRealTypeReferencedTypeTest.ClassToWeave>
    {
        protected override Action<ErrorHandler> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "impossible to ref/out the parameter 'callerParameters' in the method BeforeSetProperty of the type '{0}'",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforeSetProperty(ref object[] callerParameters)
            {
            }
        }
    }
