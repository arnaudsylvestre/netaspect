...
namespace NetAspect.Weaver.Tests.unit.CallWeaving.Fields.Getter.Parameters.After.FilePath
{
            ...
            return () =>
                {
                    ...
                    Assert.True(MyAspect.FilePath.EndsWith(@"FilePath\AfterCallGetFieldFilePathParameterWithRealTypeTest.cs"));
                };
        }
