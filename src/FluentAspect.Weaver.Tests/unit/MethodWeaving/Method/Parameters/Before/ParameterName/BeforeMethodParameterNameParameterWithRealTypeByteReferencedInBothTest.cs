...
{
    public class BeforeMethodParameterNameParameterWithRealTypeByteReferencedInBothTest : NetAspectTest<BeforeMethodParameterNameParameterWithRealTypeByteReferencedInBothTest.ClassToWeave>
   {
