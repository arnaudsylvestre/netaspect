...
{
    public class BeforeMethodParameterNameParameterWithRealTypeByteReferencedTest :
        NetAspectTest<BeforeMethodParameterNameParameterWithRealTypeByteReferencedTest.ClassToWeave>
    {
