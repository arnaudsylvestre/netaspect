...
{
    public class OnExceptionMethodMethodInfoParameterWithRealTypeReferencedTest :
        NetAspectTest<OnExceptionMethodMethodInfoParameterWithRealTypeReferencedTest.ClassToWeave>
    {
