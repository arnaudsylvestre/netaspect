...
{
   public class OnExceptionMethodMethodInfoParameterWithRealTypeOutTest : NetAspectTest<OnExceptionMethodMethodInfoParameterWithRealTypeOutTest.ClassToWeave>
   {
