...
{
    public class OnExceptionMethodParameterNameParameterWithRealTypeByteReferencedInBothTest : NetAspectTest<OnExceptionMethodParameterNameParameterWithRealTypeByteReferencedInBothTest.ClassToWeave>
   {
