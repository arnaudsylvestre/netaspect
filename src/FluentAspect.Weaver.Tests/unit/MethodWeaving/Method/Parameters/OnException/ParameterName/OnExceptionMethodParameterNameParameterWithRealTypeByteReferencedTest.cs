...
{
    public class OnExceptionMethodParameterNameParameterWithRealTypeByteReferencedTest :
        NetAspectTest<OnExceptionMethodParameterNameParameterWithRealTypeByteReferencedTest.ClassToWeave>
    {
