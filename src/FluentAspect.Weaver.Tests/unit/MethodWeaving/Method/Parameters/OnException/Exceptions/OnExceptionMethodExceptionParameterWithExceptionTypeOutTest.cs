...
{
   public class OnExceptionMethodExceptionParameterWithExceptionTypeOutTest : NetAspectTest<OnExceptionMethodExceptionParameterWithExceptionTypeOutTest.ClassToWeave>
   {
