...
{
    public class AfterMethodParameterNameParameterWithRealTypeBooleanReferencedInInterceptorTest : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeBooleanReferencedInInterceptorTest.ClassToWeave>
   {
