...
{
   public class AfterMethodParameterNameParameterWithRealTypeStructReferencedTest : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeStructReferencedTest.ClassToWeave>
   {
