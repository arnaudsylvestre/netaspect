...
{
   public class AfterMethodParameterNameParameterWithRealTypeUInt64Test : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeUInt64Test.ClassToWeave>
   {
