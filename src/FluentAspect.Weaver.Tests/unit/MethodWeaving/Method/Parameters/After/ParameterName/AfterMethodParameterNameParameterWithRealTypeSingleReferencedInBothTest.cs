...
{
    public class AfterMethodParameterNameParameterWithRealTypeSingleReferencedInBothTest : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeSingleReferencedInBothTest.ClassToWeave>
    {
