...
{
    public class AfterMethodParameterNameParameterWithRealTypeSByteReferencedInBothTest : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeSByteReferencedInBothTest.ClassToWeave>
    {
