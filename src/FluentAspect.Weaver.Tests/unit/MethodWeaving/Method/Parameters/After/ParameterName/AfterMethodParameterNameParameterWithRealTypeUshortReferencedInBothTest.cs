...
{
   public class AfterMethodParameterNameParameterWithRealTypeUshortReferencedInBothTest : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeUshortReferencedInBothTest.ClassToWeave>
   {
