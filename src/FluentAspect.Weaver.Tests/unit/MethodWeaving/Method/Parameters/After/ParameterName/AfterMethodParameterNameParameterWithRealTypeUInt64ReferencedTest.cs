...
{
   public class AfterMethodParameterNameParameterWithRealTypeUInt64ReferencedTest : NetAspectTest<AfterMethodParameterNameParameterWithRealTypeUInt64ReferencedTest.ClassToWeave>
   {
