...
{
   public class AfterMethodParameterNameParameterWithRealTypeStructTest :
      NetAspectTest<AfterMethodParameterNameParameterWithRealTypeStructTest.ClassToWeave>
   {
      ...
      public class MyAspect : Attribute
      {
         ...
         public void AfterMethod(TestStruct i)
         {
            I = i;
         }
      }
