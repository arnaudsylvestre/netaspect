...
{
    public class CheckAvailableParametersForOnExceptionPropertyGetMethodTest : NetAspectTest<CheckAvailableParametersForOnExceptionPropertyGetMethodTest.MyInt>
   {
      ...
      public class LogAttribute : Attribute
      {
         ...
         public void OnExceptionPropertyGetMethod(object unknown)
         {
         }
      }
   }
