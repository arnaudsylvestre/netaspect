...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Properties.Getter.Parameters.After.Instance
{
        ...
        NetAspectTest<AfterPropertyInstanceParameterWithBadTypeTest.ClassToWeave>
    {
        protected override Action<List<ErrorReport.Error>> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Add(new ErrorReport.Error()
                {
                    ...
                    Message =
                    string.Format(
                        "the instance parameter in the method AfterPropertyGetMethod of the type '{0}' is declared with the type 'System.Int32' but it is expected to be System.Object or {1}",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterPropertyGetMethod(int instance)
            {
            }
        }
    }
