...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Properties.Getter.Parameters.After.Property
{
        ...
        NetAspectTest<AfterPropertyPropertyInfoParameterWithBadTypeTest.ClassToWeave>
    {
        protected override Action<ErrorHandler> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "the property parameter in the property After of the type '{0}' is declared with the type 'System.Int32' but it is expected to be System.Reflection.PropertyInfo",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void After(int property)
            {
            }
        }
    }
