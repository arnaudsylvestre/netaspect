...
namespace FluentAspect.Weaver.Tests.unit.MethodWeaving.Properties.Getter.Parameters.OnFinally
{
    [TestFixture]
    public class OnFinallyPropertyGetterParameterNameParameterTest
    {
       [Test]
