...
{
    public class OnExceptionPropertyGetterMethodParameterWithRealTypeTest : NetAspectTest<OnExceptionPropertyGetterMethodParameterWithRealTypeTest.ClassToWeave>
   {
