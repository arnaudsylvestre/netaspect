...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Properties.Getter.Parameters.Before.Instance
{
        ...
        NetAspectTest<BeforePropertyInstanceParameterWithRealTypeReferencedTest.ClassToWeave>
    {
        protected override Action<List<ErrorReport.Error>> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "impossible to ref/out the parameter 'instance' in the method BeforePropertyGetMethod of the type '{0}'",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void BeforePropertyGetMethod(ref ClassToWeave instance)
            {
                Instance = instance;
            }
        }
