...
{
   public class OnExceptionPropertySetMethodParametersTest : NetAspectTest<OnExceptionPropertySetMethodParametersTest.MyInt>
   {
      public OnExceptionPropertySetMethodParametersTest()
