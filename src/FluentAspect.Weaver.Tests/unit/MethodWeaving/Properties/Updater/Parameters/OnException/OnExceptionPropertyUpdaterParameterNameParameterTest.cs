...
namespace FluentAspect.Weaver.Tests.unit.MethodWeaving.Properties.Updater.Parameters.OnException
{
    [TestFixture]
    public class OnExceptionPropertyUpdaterParameterNameParameterTest
    {
       [Test]
