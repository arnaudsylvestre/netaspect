...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Properties.Updater.Parameters.OnFinally.Parameters
{
        ...
        NetAspectTest<OnFinallyPropertyParametersParameterWithRealTypeOutTest.ClassToWeave>
    {
        protected override Action<ErrorHandler> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "impossible to ref/out the parameter 'parameters' in the method OnFinallyPropertySetMethod of the type '{0}'",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void OnFinallyPropertySetMethod(out object[] parameters)
            {
                parameters = null;
            }
        }
