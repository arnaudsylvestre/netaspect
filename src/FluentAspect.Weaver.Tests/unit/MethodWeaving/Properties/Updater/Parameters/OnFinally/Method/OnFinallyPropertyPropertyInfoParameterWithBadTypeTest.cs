...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Properties.Updater.Parameters.OnFinally.Method
{
        ...
        NetAspectTest<OnFinallyPropertyPropertyInfoParameterWithBadTypeTest.ClassToWeave>
    {
        protected override Action<ErrorHandler> CreateErrorHandlerProvider()
        {
            return
                ...
                errorHandler.Errors.Add(
                    string.Format(
                        "the Property parameter in the Property OnFinally of the type '{0}' is declared with the type 'System.Int32' but it is expected to be System.Reflection.PropertyInfo",
        ...
        public class MyAspect : Attribute
        {
            ...
            public void OnFinally(int Property)
            {
            }
        }
    }
