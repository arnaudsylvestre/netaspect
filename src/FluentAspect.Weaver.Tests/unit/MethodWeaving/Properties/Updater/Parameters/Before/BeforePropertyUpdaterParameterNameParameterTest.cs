...
namespace FluentAspect.Weaver.Tests.unit.MethodWeaving.Properties.Updater.Parameters.Before
{
    [TestFixture]
    public class BeforePropertyUpdaterParameterNameParameterTest
    {
       [Test]
