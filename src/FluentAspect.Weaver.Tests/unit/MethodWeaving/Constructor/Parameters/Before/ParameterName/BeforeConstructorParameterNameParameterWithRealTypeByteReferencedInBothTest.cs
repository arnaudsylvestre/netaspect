...
{
    public class BeforeConstructorParameterNameParameterWithRealTypeByteReferencedInBothTest :
        NetAspectTest<BeforeConstructorParameterNameParameterWithRealTypeByteReferencedInBothTest.ClassToWeave>
    {
