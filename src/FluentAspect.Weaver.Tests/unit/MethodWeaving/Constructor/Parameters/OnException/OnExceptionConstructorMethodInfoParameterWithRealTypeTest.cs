...
{
    public class OnExceptionConstructorMethodInfoParameterWithRealTypeTest : NetAspectTest<OnExceptionConstructorMethodInfoParameterWithRealTypeTest.ClassToWeave>
   {
