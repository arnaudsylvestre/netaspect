...
{
    public class OnExceptionConstructorParameterNameParameterWithRealTypeByteTest :
        NetAspectTest<OnExceptionConstructorParameterNameParameterWithRealTypeByteTest.ClassToWeave>
    {
