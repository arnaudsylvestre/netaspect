...
{
    public class AfterConstructorParameterNameParameterWithRealTypeSingleReferencedInInterceptorTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeSingleReferencedInInterceptorTest.ClassToWeave>
    {
