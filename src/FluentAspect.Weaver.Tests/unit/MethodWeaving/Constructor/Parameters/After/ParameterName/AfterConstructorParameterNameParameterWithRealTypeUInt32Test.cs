...
{
    public class AfterConstructorParameterNameParameterWithRealTypeUInt32Test :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeUInt32Test.ClassToWeave>
    {
