...
{
    public class AfterConstructorParameterNameParameterWithRealTypeShortTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeShortTest.ClassToWeave>
    {
