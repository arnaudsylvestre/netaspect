...
{
    public class AfterConstructorParameterNameParameterWithRealTypeSingleReferencedTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeSingleReferencedTest.ClassToWeave>
    {
