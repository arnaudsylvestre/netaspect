...
{
    public class AfterConstructorParameterNameParameterWithRealTypeSByteReferencedInInterceptorTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeSByteReferencedInInterceptorTest.ClassToWeave>
    {
