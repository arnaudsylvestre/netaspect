...
{
    public class AfterConstructorParameterNameParameterWithRealTypeUInt64ReferencedInInterceptorTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeUInt64ReferencedInInterceptorTest.ClassToWeave>
    {
