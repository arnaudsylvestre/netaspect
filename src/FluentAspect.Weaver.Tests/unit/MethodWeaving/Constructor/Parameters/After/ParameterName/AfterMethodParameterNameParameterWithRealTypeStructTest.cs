...
{
    public class AfterConstructorParameterNameParameterWithRealTypeStructTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeStructTest.ClassToWeave>
    {
