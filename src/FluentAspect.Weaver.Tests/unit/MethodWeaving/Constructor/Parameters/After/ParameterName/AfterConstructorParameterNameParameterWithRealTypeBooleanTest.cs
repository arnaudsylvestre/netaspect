...
{
    public class AfterConstructorParameterNameParameterWithRealTypeBooleanTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeBooleanTest.ClassToWeave>
    {
