...
{
    public class AfterConstructorParameterNameParameterWithRealTypeUshortReferencedInBothTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeUshortReferencedInBothTest.ClassToWeave>
    {
