...
{
    public class AfterConstructorParameterNameParameterWithRealTypeUshortTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeUshortTest.ClassToWeave>
    {
