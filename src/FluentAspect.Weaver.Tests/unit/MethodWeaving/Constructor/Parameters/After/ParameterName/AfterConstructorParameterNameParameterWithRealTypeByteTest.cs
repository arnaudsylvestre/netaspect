...
{
    public class AfterConstructorParameterNameParameterWithRealTypeByteTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeByteTest.ClassToWeave>
    {
