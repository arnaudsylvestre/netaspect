...
{
    public class AfterConstructorParameterNameParameterWithRealTypeInt64ReferencedTest :
        NetAspectTest<AfterConstructorParameterNameParameterWithRealTypeInt64ReferencedTest.ClassToWeave>
    {
