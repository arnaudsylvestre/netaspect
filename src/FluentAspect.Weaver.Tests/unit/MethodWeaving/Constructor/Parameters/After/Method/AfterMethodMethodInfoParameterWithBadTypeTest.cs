...
{
    public class AfterConstructorMethodInfoParameterWithBadTypeTest :
        NetAspectTest<AfterConstructorMethodInfoParameterWithBadTypeTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterConstructor(int method)
            {
            }
        }
    }
