...
{
    public class AfterConstructorResultParameterWithReferencedObjectTest :
        NetAspectTest<AfterConstructorResultParameterWithReferencedObjectTest.ClassToWeave>
    {
        ...
        public class MyAspect : Attribute
        {
            ...
            public void AfterConstructor(ref object result)
            {
            }
        }
    }
