...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Constructor.Parameters
{
   public class OnExceptionConstructorParametersTest : NetAspectTest<OnExceptionConstructorParametersTest.MyInt>
   {
      ...
      public class LogAttribute : Attribute
      {
         ...
         public void OnExceptionConstructor(object instance, MethodBase constructor, object[] parameters, int intValue, Exception exception, string fileName, string filePath, int lineNumber, int columnNumber)
         {
            Called = true;
