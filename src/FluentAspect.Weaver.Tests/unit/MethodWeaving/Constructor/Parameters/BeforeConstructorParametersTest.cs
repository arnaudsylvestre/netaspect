...
namespace NetAspect.Weaver.Tests.unit.MethodWeaving.Constructor.Parameters
{
   public class BeforeConstructorParametersTest : NetAspectTest<BeforeConstructorParametersTest.MyInt>
   {
      ...
      public class LogAttribute : Attribute
      {
         ...
         public void BeforeConstructor(object instance, MethodBase constructor, object[] parameters, int intValue, string fileName, string filePath, int lineNumber, int columnNumber)
         {
            Called = true;
