        ...
        NetAspectTest<Part8Sample3OnExceptionParameterPossibilityTest.MyInt>
    {
            ...
            : base("On exception parameter", "ParameterWeavingOnException", "ParameterWeaving")
      {
        ...
        public class LogAttribute : Attribute
        {
            ...
            public void OnExceptionMethodForParameter(int parameterValue, string parameterName, MyInt instance,
               int v, object[] parameters, ParameterInfo parameter, Exception exception)
            {
               Called = true;
